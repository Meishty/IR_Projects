...
0x00400068:	ldclne	p3, c6, [r3, #-0x354]
0x0040006c:	cmpmi	sl, ip, lsr #21
0x00400070:	svcls	#0xfa7faf
0x00400074:	svcge	#0x4a9381
0x00400078:	stcmi	p8, c11, [ip], {0x77}
0x0040007c:	ldmdbmi	r1, {r0, r1, r5, r6, ip, sp, pc}
0x00400080:	andeq	r0, r0, sl, asr #18
0x00400084:	stmvs	r6, {r4, r5, r6, r7, r8, sl, ip, sp, pc}

Function CLOCK_R @ 0x00400085
0x00400085:	push	{r4, r5, r6, r7, lr}
0x00400087:	ldr	r6, [r0, #8]
...
0x004002b3:	nop	
0x004002b5:	lsls	r2, r0, #0x1e
0x004002b7:	movs	r0, r0
0x004002b9:	lsls	r2, r2, #0x1b
...
Function ECRYPT_keysetup @ 0x004002bd
0x004002bd:	subs	r2, r0, r1
0x004002bf:	adds	r2, #0x17
0x004002c1:	cmp	r2, #2
0x004002c3:	bls	#0x4002dd
...
Function ECRYPT_ivsetup @ 0x0040030d
...
Function ECRYPT_process_bytes @ 0x00400609
0x00400609:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040060d:	sub	sp, #0x24
0x0040060f:	ldr	r0, [sp, #0x48]
0x00400611:	cmp	r0, #0
...
0x004007ab:	nop	
0x004007ad:	lsls	r2, r6, #0xc
0x004007af:	movs	r0, r0
0x004007b1:	lsls	r6, r5, #0xc
0x004007b3:	movs	r0, r0
0x004007b5:	cmp	r2, #0
0x004007b7:	beq.w	#0x40094b

Function ECRYPT_keystream_bytes @ 0x004007b5
0x004007b5:	cmp	r2, #0
0x004007b7:	beq.w	#0x40094b
