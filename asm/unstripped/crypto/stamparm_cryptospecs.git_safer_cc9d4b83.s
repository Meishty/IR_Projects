...
Function Safer_Init_Module @ 0x00400001
0x00400001:	ldr.w	ip, [pc, #0x70]
...
0x00400073:	nop	
0x00400075:	lsrs	r4, r0, #6
0x00400077:	movs	r0, r0
0x00400079:	lsrs	r0, r2, #5
...
Function Safer_Expand_Userkey @ 0x0040007d
0x0040007d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400081:	mov	r6, r2
0x00400083:	ldr.w	r5, [pc, #0x54c]
0x00400087:	sub	sp, #0x84
...
0x004005cd:	bl	#0x500001

Function Safer_Encrypt_Block @ 0x004005e1
...
Function Safer_Decrypt_Block @ 0x00400785
