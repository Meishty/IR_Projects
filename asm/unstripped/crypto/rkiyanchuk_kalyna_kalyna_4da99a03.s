...
/root/projects/compiled/crypto/unstripped/rkiyanchuk_kalyna_kalyna_4da99a03.o:     file format elf32-littlearm
...
000002b0 <ShiftRows>:
     ...
     2b4:	2400      	movs	r4, #0
     2b6:	6806      	ldr	r6, [r0, #0]
     2b8:	b083      	sub	sp, #12
     2ba:	68c3      	ldr	r3, [r0, #12]
     2bc:	f04f 39ff 	mov.w	r9, #4294967295	; 0xffffffff
...
00000328 <InvShiftRows>:
     ...
     32c:	2400      	movs	r4, #0
     32e:	6806      	ldr	r6, [r0, #0]
     330:	b083      	sub	sp, #12
     332:	f8d0 800c 	ldr.w	r8, [r0, #12]
     336:	f04f 39ff 	mov.w	r9, #4294967295	; 0xffffffff
...
00000ee8 <KalynaEncipher>:
     ...
     f4c:	9c02      	ldr	r4, [sp, #8]
     f4e:	f04f 39ff 	mov.w	r9, #4294967295	; 0xffffffff
     f52:	4620      	mov	r0, r4
     f54:	f7ff fffe 	bl	180 <SubBytes>
     f58:	6826      	ldr	r6, [r4, #0]
...
00001060 <KalynaDecipher>:
    ...
    10bc:	4b60      	ldr	r3, [pc, #384]	; (1240 <KalynaDecipher+0x1e0>)
    10be:	58e3      	ldr	r3, [r4, r3]
    10c0:	ee08 3a10 	vmov	s16, r3
    10c4:	d059      	beq.n	117a <KalynaDecipher+0x11a>
    10c6:	9c02      	ldr	r4, [sp, #8]
    10c8:	ee18 1a10 	vmov	r1, s16
    10cc:	f04f 39ff 	mov.w	r9, #4294967295	; 0xffffffff
    10d0:	4620      	mov	r0, r4
    10d2:	f7ff fffe 	bl	458 <MatrixMultiply>
    10d6:	6826      	ldr	r6, [r4, #0]
    10d8:	f8d4 800c 	ldr.w	r8, [r4, #12]
    10dc:	2400      	movs	r4, #0
    10de:	00f0      	lsls	r0, r6, #3
    10e0:	f7ff fffe 	bl	0 <malloc>
    10e4:	4631      	mov	r1, r6
    10e6:	4603      	mov	r3, r0
    10e8:	2008      	movs	r0, #8
    10ea:	9301      	str	r3, [sp, #4]
    10ec:	f7ff fffe 	bl	0 <__aeabi_uidiv>
    10f0:	4682      	mov	sl, r0
    10f2:	4651      	mov	r1, sl
    10f4:	4620      	mov	r0, r4
    10f6:	f7ff fffe 	bl	0 <__aeabi_uidivmod>
    10fa:	b909      	cbnz	r1, 1100 <KalynaDecipher+0xa0>
    10fc:	f109 0901 	add.w	r9, r9, #1
    1100:	b19e      	cbz	r6, 112a <KalynaDecipher+0xca>
    1102:	9b01      	ldr	r3, [sp, #4]
    1104:	eba4 05c9 	sub.w	r5, r4, r9, lsl #3
    1108:	46cb      	mov	fp, r9
    110a:	eb06 0709 	add.w	r7, r6, r9
    110e:	441d      	add	r5, r3
    1110:	4658      	mov	r0, fp
    1112:	4631      	mov	r1, r6
    1114:	f7ff fffe 	bl	0 <__aeabi_uidivmod>
    1118:	eb08 01c1 	add.w	r1, r8, r1, lsl #3
    111c:	5d0b      	ldrb	r3, [r1, r4]
    111e:	f805 303b 	strb.w	r3, [r5, fp, lsl #3]
    1122:	f10b 0b01 	add.w	fp, fp, #1
    1126:	455f      	cmp	r7, fp
    1128:	d1f2      	bne.n	1110 <KalynaDecipher+0xb0>
    112a:	3401      	adds	r4, #1
    112c:	2c08      	cmp	r4, #8
    112e:	d1e0      	bne.n	10f2 <KalynaDecipher+0x92>
    1130:	9c02      	ldr	r4, [sp, #8]
    1132:	4640      	mov	r0, r8
    1134:	9a01      	ldr	r2, [sp, #4]
    1136:	60e2      	str	r2, [r4, #12]
    1138:	f7ff fffe 	bl	0 <free>
    113c:	4620      	mov	r0, r4
    113e:	f7ff fffe 	bl	218 <InvSubBytes>
    1142:	6825      	ldr	r5, [r4, #0]
    1144:	b1ad      	cbz	r5, 1172 <KalynaDecipher+0x112>
    1146:	9b02      	ldr	r3, [sp, #8]
    1148:	9903      	ldr	r1, [sp, #12]
    114a:	e9d3 3203 	ldrd	r3, r2, [r3, #12]
    114e:	f852 0021 	ldr.w	r0, [r2, r1, lsl #2]
    1152:	eb03 05c5 	add.w	r5, r3, r5, lsl #3
    1156:	3808      	subs	r0, #8
    1158:	f850 1f08 	ldr.w	r1, [r0, #8]!
    115c:	e9d3 2400 	ldrd	r2, r4, [r3]
    1160:	4051      	eors	r1, r2
    1162:	6842      	ldr	r2, [r0, #4]
    1164:	f843 1b08 	str.w	r1, [r3], #8
    1168:	4062      	eors	r2, r4
    116a:	429d      	cmp	r5, r3
    116c:	f843 2c04 	str.w	r2, [r3, #-4]
    1170:	d1f2      	bne.n	1158 <KalynaDecipher+0xf8>
    1172:	9b03      	ldr	r3, [sp, #12]
    1174:	3b01      	subs	r3, #1
    1176:	9303      	str	r3, [sp, #12]
    1178:	d1a5      	bne.n	10c6 <KalynaDecipher+0x66>
    117a:	9c02      	ldr	r4, [sp, #8]
    117c:	ee18 1a10 	vmov	r1, s16
    1180:	f04f 39ff 	mov.w	r9, #4294967295	; 0xffffffff
    1184:	4620      	mov	r0, r4
    1186:	f7ff fffe 	bl	458 <MatrixMultiply>
    118a:	6826      	ldr	r6, [r4, #0]
    118c:	f8d4 800c 	ldr.w	r8, [r4, #12]
    1190:	2400      	movs	r4, #0
    1192:	00f0      	lsls	r0, r6, #3
    1194:	f7ff fffe 	bl	0 <malloc>
    1198:	4631      	mov	r1, r6
    119a:	9001      	str	r0, [sp, #4]
    119c:	2008      	movs	r0, #8
    119e:	f7ff fffe 	bl	0 <__aeabi_uidiv>
    11a2:	4682      	mov	sl, r0
    11a4:	4651      	mov	r1, sl
    11a6:	4620      	mov	r0, r4
    11a8:	f7ff fffe 	bl	0 <__aeabi_uidivmod>
    11ac:	b909      	cbnz	r1, 11b2 <KalynaDecipher+0x152>
    11ae:	f109 0901 	add.w	r9, r9, #1
    11b2:	b19e      	cbz	r6, 11dc <KalynaDecipher+0x17c>
    11b4:	9b01      	ldr	r3, [sp, #4]
    11b6:	eba4 05c9 	sub.w	r5, r4, r9, lsl #3
    11ba:	46cb      	mov	fp, r9
    11bc:	eb06 0709 	add.w	r7, r6, r9
    11c0:	441d      	add	r5, r3
    11c2:	4658      	mov	r0, fp
    11c4:	4631      	mov	r1, r6
    11c6:	f7ff fffe 	bl	0 <__aeabi_uidivmod>
    11ca:	eb08 01c1 	add.w	r1, r8, r1, lsl #3
    11ce:	5d0b      	ldrb	r3, [r1, r4]
    11d0:	f805 303b 	strb.w	r3, [r5, fp, lsl #3]
    11d4:	f10b 0b01 	add.w	fp, fp, #1
    11d8:	455f      	cmp	r7, fp
    11da:	d1f2      	bne.n	11c2 <KalynaDecipher+0x162>
    11dc:	3401      	adds	r4, #1
    11de:	2c08      	cmp	r4, #8
    11e0:	d1e0      	bne.n	11a4 <KalynaDecipher+0x144>
    11e2:	9c02      	ldr	r4, [sp, #8]
    11e4:	4640      	mov	r0, r8
    11e6:	9a01      	ldr	r2, [sp, #4]
    11e8:	60e2      	str	r2, [r4, #12]
    11ea:	f7ff fffe 	bl	0 <free>
    11ee:	4620      	mov	r0, r4
    11f0:	f7ff fffe 	bl	218 <InvSubBytes>
    11f4:	6822      	ldr	r2, [r4, #0]
    11f6:	b1ea      	cbz	r2, 1234 <KalynaDecipher+0x1d4>
    11f8:	e9d4 1003 	ldrd	r1, r0, [r4, #12]
    11fc:	00d2      	lsls	r2, r2, #3
    11fe:	460b      	mov	r3, r1
    1200:	1857      	adds	r7, r2, r1
    1202:	6805      	ldr	r5, [r0, #0]
    1204:	3d08      	subs	r5, #8
    1206:	f855 6f08 	ldr.w	r6, [r5, #8]!
    120a:	e9d3 0400 	ldrd	r0, r4, [r3]
    120e:	1b80      	subs	r0, r0, r6
    1210:	686e      	ldr	r6, [r5, #4]
    1212:	f843 0b08 	str.w	r0, [r3], #8
    1216:	eb64 0406 	sbc.w	r4, r4, r6
    121a:	42bb      	cmp	r3, r7
    121c:	f843 4c04 	str.w	r4, [r3, #-4]
    1220:	d1f1      	bne.n	1206 <KalynaDecipher+0x1a6>
    1222:	ee18 0a90 	vmov	r0, s17
    1226:	b005      	add	sp, #20
    1228:	ecbd 8b02 	vpop	{d8}
    122c:	e8bd 4ff0 	ldmia.w	sp!, {r4, r5, r6, r7, r8, r9, sl, fp, lr}
    1230:	f7ff bffe 	b.w	0 <memcpy>
    1234:	9b02      	ldr	r3, [sp, #8]
    1236:	68d9      	ldr	r1, [r3, #12]
    1238:	e7f3      	b.n	1222 <KalynaDecipher+0x1c2>
    123a:	bf00      	nop
