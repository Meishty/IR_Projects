...
Function make_q_table @ 0x00400001
...
Function fill_keyed_sboxes @ 0x00400259
0x00400259:	cmp	r1, #3
...
Function Twofish_prepare_key.part.0 @ 0x004004c1
...
Function Twofish_prepare_key.part.0.constprop.0 @ 0x004007b5
0x004007b5:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004007b9:	mov	r5, r2
0x004007bb:	ldr	r3, [pc, #0x2c4]
0x004007bd:	sub	sp, #0x54
...
0x00400ad7:	bl	#0x50000d

Function Twofish_prepare_key.part.0.constprop.1 @ 0x00400a91
0x00400a91:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400a95:	mov	r4, r2
0x00400a97:	ldr	r1, [pc, #0x294]
0x00400a99:	sub	sp, #0x54
...
Function Twofish_prepare_key @ 0x00400d3d
0x00400d3d:	ldr	r3, [pc, #0xc]
0x00400d3f:	add	r3, pc
0x00400d41:	ldr.w	r3, [r3, #0x200]
0x00400d45:	cbz	r3, #0x400d4b
...
Function Twofish_encrypt_block @ 0x00400d51
...
0x00400ead:	ldr.w	r1, [r0, r1, lsl #2]
...
0x004015f1:	bl	#0x50000d

Function test_odd_sized_keys @ 0x004015c5
0x004015c5:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x004015c9:	movs	r2, #0x20
0x004015cb:	ldr	r5, [pc, #0xf4]
0x004015cd:	ldr	r3, [pc, #0xf4]
...
Function Twofish_decrypt_block @ 0x004016d1
0x004016d1:	add.w	r3, r0, #0x1000
0x004016d5:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x004016d9:	ldr	r7, [r1]
0x004016db:	ldr	r4, [r3, #0x10]
...
0x00401823:	ldr.w	r8, [r0, r4, lsl #2]
...
Function test_vector.part.0 @ 0x00401f11
0x00401f11:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00401f15:	mov	r4, r2
0x00401f17:	ldr	r2, [pc, #0xec]
0x00401f19:	mov	r5, r3
...
0x00402001:	bl	#0x500019

Function test_sequence.constprop.0 @ 0x00402011
...
0x0040210d:	lsrs	r6, r2, #0x13
0x0040210f:	movs	r0, r0
0x00402111:	lsrs	r6, r3, #0xc
...
0x00402149:	bl	#0x50000d

Function test_sequence.constprop.1 @ 0x00402119
0x00402119:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040211d:	mov.w	r2, #0x350
0x00402121:	ldr	r4, [pc, #0x37c]
0x00402123:	ldr	r3, [pc, #0x380]
...
0x0040249d:	bl	#0x500019

Function test_sequence.constprop.2 @ 0x004024b9
...
0x004025a1:	bl	#0x500019

Function Twofish_initialise @ 0x004025b9
...
Function Twofish_get_block_count @ 0x0040274d
...
Function Twofish_get_output_length @ 0x00402769
...
Function Twofish_encrypt @ 0x0040278d
...
0x004029d1:	bl	#0x500019

Function Twofish_decrypt @ 0x004029e1
