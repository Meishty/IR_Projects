...
Function blockmix_salsa8 @ 0x00400295
0x00400295:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x00400299:	mov	r4, r2
0x0040029b:	add.w	r7, r0, r3, lsl #7
0x0040029f:	sub.w	r2, r7, #0x40
...
Function _sodium_escrypt_kdf_nosse @ 0x0040045d
0x0040045d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400461:	mov	r8, r3
0x00400463:	vpush	{d8}
0x00400467:	sub	sp, #0x64
...
Function _sodium_escrypt_PBKDF2_SHA256 @ 0x00500019
...
Function _sodium_escrypt_free_region @ 0x00500031
...
Function _sodium_escrypt_alloc_region @ 0x0050003d
