...
Function crypto_pwhash_scryptsalsa208sha256_bytes_min @ 0x00400001
0x00400001:	movs	r0, #0x10
0x00400003:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_bytes_max @ 0x00400005
...
Function crypto_pwhash_scryptsalsa208sha256_passwd_min @ 0x0040000d
0x0040000d:	movs	r0, #0
0x0040000f:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_passwd_max @ 0x00400011
...
Function crypto_pwhash_scryptsalsa208sha256_saltbytes @ 0x00400019
0x00400019:	movs	r0, #0x20
0x0040001b:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_strbytes @ 0x0040001d
0x0040001d:	movs	r0, #0x66
0x0040001f:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_strprefix @ 0x00400021
...
0x00400027:	nop	
0x00400029:	lsls	r6, r0, #0x15
0x0040002b:	movs	r0, r0
0x0040002d:	mov.w	r0, #0x8000
0x00400031:	movs	r1, #0
0x00400033:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_opslimit_min @ 0x0040002d
0x0040002d:	mov.w	r0, #0x8000
0x00400031:	movs	r1, #0
0x00400033:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_opslimit_max @ 0x00400035
0x00400035:	mov.w	r0, #-1
0x00400039:	movs	r1, #0
0x0040003b:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_memlimit_min @ 0x0040003d
...
Function crypto_pwhash_scryptsalsa208sha256_memlimit_max @ 0x00400045
0x00400045:	mov.w	r0, #-1
0x00400049:	bx	lr
...
Function crypto_pwhash_scryptsalsa208sha256_opslimit_interactive @ 0x0040004d
0x0040004d:	mov.w	r0, #0x80000
0x00400051:	movs	r1, #0
0x00400053:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_memlimit_interactive @ 0x00400055
...
Function crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive @ 0x0040005d
0x0040005d:	mov.w	r0, #0x2000000
0x00400061:	movs	r1, #0
0x00400063:	bx	lr

Function crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive @ 0x00400065
...
Function crypto_pwhash_scryptsalsa208sha256 @ 0x0040006d
0x0040006d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400071:	mov	r7, r3
0x00400073:	movs	r1, #0
0x00400075:	sub	sp, #0xc
...
Function crypto_pwhash_scryptsalsa208sha256_str @ 0x004001bd
...
0x00400297:	bl	#0x50003d
0x0040029b:	cmp	r0, #0
0x0040029d:	beq	#0x400343
0x0040029f:	mov	r0, sb
0x004002a1:	bl	#0x500049
...
Function crypto_pwhash_scryptsalsa208sha256_str_verify @ 0x00400369
0x00400369:	push.w	{r4, r5, r6, r7, r8, sb, lr}
0x0040036d:	mov	r6, r2
0x0040036f:	ldr	r2, [pc, #0xb0]
0x00400371:	ldr	r3, [pc, #0xb0]
...
Function crypto_pwhash_scryptsalsa208sha256_str_needs_rehash @ 0x0040042d
0x0040042d:	push.w	{r4, r5, r6, r7, r8, sb, lr}
0x00400431:	cmp.w	r2, #0x8000
0x00400435:	ldr	r4, [pc, #0x128]
0x00400437:	ldr	r1, [pc, #0x12c]
...
Function _sodium_escrypt_gensalt_r @ 0x00500025
...
Function _sodium_escrypt_init_local @ 0x00500031
...
Function _sodium_escrypt_r @ 0x0050003d
...
Function _sodium_escrypt_free_local @ 0x00500049
...
Function sodium_memcmp @ 0x00500061
...
Function _sodium_escrypt_parse_setting @ 0x00500079
...
Function crypto_pwhash_scryptsalsa208sha256_ll @ 0x00500085
