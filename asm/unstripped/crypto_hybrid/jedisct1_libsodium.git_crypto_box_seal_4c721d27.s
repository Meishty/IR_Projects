...
/root/projects/compiled/crypto_hybrid/unstripped/jedisct1_libsodium.git_crypto_box_seal_4c721d27.o:     file format elf32-littlearm


Disassembly of section .text:

00000000 <_crypto_box_seal_nonce>:
   0:	b5f0      	push	{r4, r5, r6, r7, lr}
   2:	460f      	mov	r7, r1
   4:	491a      	ldr	r1, [pc, #104]	; (70 <_crypto_box_seal_nonce+0x70>)
   6:	4616      	mov	r6, r2
   8:	4a1a      	ldr	r2, [pc, #104]	; (74 <_crypto_box_seal_nonce+0x74>)
   a:	4479      	add	r1, pc
  ...
  50:	4a09      	ldr	r2, [pc, #36]	; (78 <_crypto_box_seal_nonce+0x78>)
  52:	4b08      	ldr	r3, [pc, #32]	; (74 <_crypto_box_seal_nonce+0x74>)
  54:	447a      	add	r2, pc
  ...
  62:	d102      	bne.n	6a <_crypto_box_seal_nonce+0x6a>
  64:	2000      	movs	r0, #0
...
0000007c <crypto_box_seal>:
  7c:	e92d 4ff0 	stmdb	sp!, {r4, r5, r6, r7, r8, r9, sl, fp, lr}
  80:	4691      	mov	r9, r2
  82:	4a37      	ldr	r2, [pc, #220]	; (160 <crypto_box_seal+0xe4>)
  84:	4698      	mov	r8, r3
  86:	4b37      	ldr	r3, [pc, #220]	; (164 <crypto_box_seal+0xe8>)
  88:	447a      	add	r2, pc
  ...
  aa:	f7ff fffe 	bl	0 <crypto_box_keypair>
  ae:	2800      	cmp	r0, #0
  b0:	d150      	bne.n	154 <crypto_box_seal+0xd8>
  ...
  fc:	9500      	str	r5, [sp, #0]
  fe:	f7ff fffe 	bl	0 <crypto_box_easy>
 102:	46b4      	mov	ip, r6
 104:	4607      	mov	r7, r0
 ...
 136:	4a0c      	ldr	r2, [pc, #48]	; (168 <crypto_box_seal+0xec>)
 138:	4b0a      	ldr	r3, [pc, #40]	; (164 <crypto_box_seal+0xe8>)
 13a:	447a      	add	r2, pc
 ...
 148:	d107      	bne.n	15a <crypto_box_seal+0xde>
 14a:	4638      	mov	r0, r7
 ...
 158:	e7ed      	b.n	136 <crypto_box_seal+0xba>
...
0000016c <crypto_box_seal_open>:
 16c:	e92d 43f0 	stmdb	sp!, {r4, r5, r6, r7, r8, r9, lr}
 170:	4614      	mov	r4, r2
 172:	4a1a      	ldr	r2, [pc, #104]	; (1dc <crypto_box_seal_open+0x70>)
 174:	461d      	mov	r5, r3
 176:	4b1a      	ldr	r3, [pc, #104]	; (1e0 <crypto_box_seal_open+0x74>)
 178:	447a      	add	r2, pc
 ...
 190:	d31f      	bcc.n	1d2 <crypto_box_seal_open+0x66>
 192:	af05      	add	r7, sp, #20
 194:	4680      	mov	r8, r0
 196:	4638      	mov	r0, r7
 198:	460e      	mov	r6, r1
 19a:	f7ff ff31 	bl	0 <_crypto_box_seal_nonce>
 ...
 1b4:	f7ff fffe 	bl	0 <crypto_box_open_easy>
 1b8:	4a0a      	ldr	r2, [pc, #40]	; (1e4 <crypto_box_seal_open+0x78>)
 1ba:	4b09      	ldr	r3, [pc, #36]	; (1e0 <crypto_box_seal_open+0x74>)
 1bc:	447a      	add	r2, pc
