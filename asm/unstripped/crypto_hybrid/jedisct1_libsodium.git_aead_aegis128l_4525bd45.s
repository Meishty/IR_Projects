...
Function crypto_aead_aegis128l_keybytes @ 0x00400001
0x00400001:	movs	r0, #0x10
0x00400003:	bx	lr

Function crypto_aead_aegis128l_nsecbytes @ 0x00400005
0x00400005:	movs	r0, #0
0x00400007:	bx	lr

Function crypto_aead_aegis128l_npubbytes @ 0x00400009
0x00400009:	movs	r0, #0x10
0x0040000b:	bx	lr

Function crypto_aead_aegis128l_abytes @ 0x0040000d
0x0040000d:	movs	r0, #0x20
0x0040000f:	bx	lr

Function crypto_aead_aegis128l_messagebytes_max @ 0x00400011
...
Function crypto_aead_aegis128l_keygen @ 0x00400019
0x00400019:	movs	r1, #0x10
0x0040001b:	b.w	#0x50000d
...
Function crypto_aead_aegis128l_encrypt @ 0x00400021
0x00400021:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400025:	mov	r5, r1
0x00400027:	sub	sp, #0x18
0x00400029:	ldrd	r6, r7, [sp, #0x30]
...
Function crypto_aead_aegis128l_decrypt @ 0x00400099
0x00400099:	push.w	{r4, r5, r6, r7, r8, lr}
0x0040009d:	mov	r7, r1
0x0040009f:	mov	r1, r3
0x004000a1:	sub	sp, #0x18
...
Function crypto_aead_aegis128l_encrypt_detached @ 0x0040012d
...
Function crypto_aead_aegis128l_decrypt_detached @ 0x00400195
...
Function _crypto_aead_aegis128l_pick_best_implementation @ 0x004001f1
0x004001f1:	ldr	r3, [pc, #0x10]
0x004001f3:	movs	r0, #0
0x004001f5:	ldr	r1, [pc, #0x10]
0x004001f7:	ldr	r2, [pc, #0x14]
