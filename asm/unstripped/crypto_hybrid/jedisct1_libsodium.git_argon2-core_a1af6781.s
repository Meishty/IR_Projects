...
Function _sodium_argon2_finalize @ 0x004000e9
0x004000e9:	ldr	r2, [pc, #0x1d0]
0x004000eb:	cmp	r0, #0
0x004000ed:	it	ne
0x004000ef:	cmpne	r1, #0
...
Function _sodium_argon2_fill_memory_blocks @ 0x004002c9
0x004002c9:	cbz	r0, #0x40031b
0x004002cb:	ldr	r3, [r0, #0x1c]
0x004002cd:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x004002d1:	mov	r6, r0
...
Function _sodium_argon2_validate_inputs @ 0x00400321
0x00400321:	cmp	r0, #0
...
Function _sodium_argon2_initialize @ 0x004003f5
0x004003f5:	ldr	r2, [pc, #0x228]
0x004003f7:	cmp	r1, #0
0x004003f9:	it	ne
0x004003fb:	cmpne	r0, #0
...
0x004005fb:	bl	#0x500031
0x004005f7:	ldr	r0, [r4]
0x004005f9:	cbz	r0, #0x4005ff
0x004005fb:	bl	#0x500031
0x004005fb:	bl	#0x500031
0x004005ff:	mov	r0, r4
0x00400601:	bl	#0x500031
...
Function _crypto_pwhash_argon2_pick_best_implementation @ 0x0040062d
0x0040062d:	ldr	r3, [pc, #0x10]
0x0040062f:	movs	r0, #0
0x00400631:	ldr	r1, [pc, #0x10]
0x00400633:	ldr	r2, [pc, #0x14]
...
0x00400649:	movs	r2, r2
0x0040064b:	movs	r0, r0

Function _sodium_blake2b_long @ 0x00500001
...
Function crypto_generichash_blake2b_init @ 0x00500055
...
Function crypto_generichash_blake2b_update @ 0x00500061
...
Function crypto_generichash_blake2b_final @ 0x0050006d
