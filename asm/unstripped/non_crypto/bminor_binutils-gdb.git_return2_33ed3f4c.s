...
0x0040000c:	muleq	r0, r8, r0
0x00400010:	ldrbtmi	r4, [fp], #-0xb01

Function char_func @ 0x00400011
0x00400011:	ldr	r3, [pc, #4]
0x00400013:	add	r3, pc
0x00400015:	ldrb	r0, [r3]
0x00400017:	bx	lr

Function short_func @ 0x0040001d
...
Function int_func @ 0x0040002d
0x0040002d:	ldr	r3, [pc, #4]
0x0040002f:	add	r3, pc
0x00400031:	ldr	r0, [r3, #4]
0x00400033:	bx	lr

Function long_func @ 0x00400039
0x00400039:	ldr	r3, [pc, #4]
0x0040003b:	add	r3, pc
0x0040003d:	ldr	r0, [r3, #8]
0x0040003f:	bx	lr

Function long_long_func @ 0x00400045
...
Function float_func @ 0x00400055
0x00400055:	ldr	r3, [pc, #8]
0x00400057:	add	r3, pc
0x00400059:	vldr	s0, [r3, #0x18]
0x0040005d:	bx	lr
...
Function double_func @ 0x00400065
0x00400065:	ldr	r3, [pc, #8]
0x00400067:	add	r3, pc
0x00400069:	vldr	d0, [r3, #0x20]
0x0040006d:	bx	lr
