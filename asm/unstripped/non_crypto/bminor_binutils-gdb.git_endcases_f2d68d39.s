...
Function xinline_code @ 0x00400029
...
0x0040005d:	add	sp, #8
0x0040005f:	b.w	#0x500001

Function sub_400063 @ 0x00400063
0x00400063:	nop	
0x00400065:	lsls	r2, r0, #0x1d
0x00400067:	movs	r0, r0
0x00400069:	lsls	r6, r4, #0x1c
...
Function macro_code @ 0x0040006d
0x0040006d:	ldr	r3, [pc, #0x38]
0x0040006f:	sub	sp, #8
0x00400071:	movs	r2, #0
0x00400073:	add	r3, pc
...
0x004000a3:	add	sp, #8
0x004000a5:	b.w	#0x500001

Function ext_macro_code @ 0x004000b1
...
0x004000f9:	add	sp, #8
0x004000fb:	b.w	#0x500001

Function sub_4000ff @ 0x004000ff
0x004000ff:	nop	
0x00400101:	lsls	r6, r2, #0x1b
...
0x0040021d:	add	sp, #8
0x0040021f:	b.w	#0x500001

Function sub_400223 @ 0x00400223
0x00400223:	nop	
0x00400225:	lsls	r4, r3, #0x16
0x00400227:	movs	r0, r0
0x00400229:	lsls	r6, r3, #0x17
...
Function inc_middle @ 0x0040022d
0x0040022d:	ldr	r3, [pc, #0xe0]
0x0040022f:	movs	r1, #0
0x00400231:	push	{r4, lr}
0x00400233:	mov	r4, r0
...
0x0040030b:	b.w	#0x500001

Function sub_40030f @ 0x0040030f
0x0040030f:	nop	
0x00400311:	lsls	r4, r7, #0x14
0x00400313:	movs	r0, r0
0x00400315:	lsls	r4, r7, #0x14
0x00400317:	movs	r0, r0
0x00400319:	lsls	r0, r1, #0x12
0x0040031b:	movs	r0, r0
0x0040031d:	lsls	r6, r0, #0x15
...
0x00400333:	bl	#0x50000d

Function endcases @ 0x00400321
0x00400321:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400325:	mov	r8, r0
0x00400327:	ldr	r4, [pc, #0x334]
0x00400329:	vpush	{d8, d9}
...
0x004006db:	nop	
0x004006dd:	lsls	r6, r2, #3
0x004006df:	movs	r0, r0
0x004006e1:	lsls	r4, r7, #2
...
0x0040076b:	nop	
0x0040076d:	lsls	r4, r0, #2
0x0040076f:	movs	r0, r0
0x00400771:	lsls	r6, r1, #5
...
Function gethrvtime @ 0x00500019
