...
Function mp_compare @ 0x00400075
0x00400075:	ldr	r3, [pc, #0x40]
0x00400077:	add	r3, pc
0x00400079:	ldrsh.w	r2, [r3]
0x0040007d:	add.w	r3, r2, #-0x80000000
...
Function significance @ 0x004001b5
0x004001b5:	ldr	r3, [pc, #0x24]
0x004001b7:	add	r3, pc
0x004001b9:	ldrsh.w	r3, [r3]
0x004001bd:	add.w	r2, r3, #-0x80000000
...
0x004004c9:	asrs	r6, r2, #6
0x004004cb:	movs	r0, r0
0x004004cd:	asrs	r0, r7, #4
0x004004cf:	movs	r0, r0
0x004004d1:	asrs	r6, r4, #2
...
0x004007e3:	nop	
0x004007e5:	lsrs	r0, r4, #0x1f
0x004007e7:	movs	r0, r0
0x004007e9:	lsrs	r4, r4, #0x1e
0x004007eb:	movs	r0, r0
0x004007ed:	lsrs	r6, r4, #0x1c
0x004007ef:	movs	r0, r0
0x004007f1:	lsrs	r2, r6, #0x1a
0x004007f3:	movs	r0, r0
0x004007f5:	lsrs	r2, r0, #0x19
0x004007f7:	movs	r0, r0
0x004007f9:	lsrs	r6, r4, #0x15
0x004007fb:	movs	r0, r0
0x004007fd:	cmp	r2, #0
0x004007ff:	beq	#0x4008ab

Function mp_shortdiv @ 0x004007fd
0x004007fd:	cmp	r2, #0
0x004007ff:	beq	#0x4008ab
...
Function mp_shortmod @ 0x004009d5
0x004009d5:	cmp	r1, #0
...
0x00400a93:	bl	#0x500001

Function mp_mult @ 0x00400a7d
0x00400a7d:	push.w	{r3, r4, r5, r6, r7, r8, sb, lr}
0x00400a81:	mov	r8, r2
0x00400a83:	ldr	r4, [pc, #0xc0]
0x00400a85:	mov	r6, r0
...
0x00400ba7:	bl	#0x500055

Function stage_upton_modulus @ 0x00400b91
0x00400b91:	push	{r3, r4, r5, lr}
0x00400b93:	mov	r1, r0
0x00400b95:	ldr	r5, [pc, #0x94]
0x00400b97:	mov.w	r3, #0x104
...
0x00400c2b:	nop	
0x00400c2d:	lsrs	r2, r5, #4
0x00400c2f:	movs	r0, r0
0x00400c31:	lsrs	r4, r5, #3
0x00400c33:	movs	r0, r0
0x00400c35:	lsrs	r2, r5, #2
...
0x00400c65:	bl	#0x500025

Function upton_modmult @ 0x00400c39
0x00400c39:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400c3d:	mov.w	r3, #0x208
0x00400c41:	ldr	r6, [pc, #0x2ec]
0x00400c43:	vpush	{d8}
...
0x00400f2f:	nop	
0x00400f31:	lsrs	r4, r7, #1
0x00400f33:	movs	r0, r0
0x00400f35:	lsrs	r4, r3, #0x20
0x00400f37:	movs	r0, r0
0x00400f39:	lsls	r6, r3, #0x1e
0x00400f3b:	movs	r0, r0
0x00400f3d:	lsls	r2, r0, #0x1e
0x00400f3f:	movs	r0, r0
0x00400f41:	lsls	r0, r5, #0x1b
0x00400f43:	movs	r0, r0
0x00400f45:	lsls	r4, r5, #0x1a
0x00400f47:	movs	r0, r0
0x00400f49:	lsls	r6, r4, #0x1a
0x00400f4b:	movs	r0, r0
0x00400f4d:	lsls	r2, r0, #0x19
0x00400f4f:	movs	r0, r0
0x00400f51:	lsls	r4, r6, #0x16
...
0x00400f67:	bl	#0x500001

Function upton_burn @ 0x00400f55
0x00400f55:	push	{r3, r4, r5, lr}
0x00400f57:	mov.w	r2, #0x104
0x00400f5b:	ldr	r4, [pc, #0x5c]
0x00400f5d:	movs	r1, #0
...
0x00401047:	bl	#0x500001

Function mp_modexp @ 0x0040101d
0x0040101d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00401021:	mov	r7, r2
0x00401023:	ldr	r4, [pc, #0x38c]
0x00401025:	ldr	r2, [pc, #0x38c]
...
0x004013ad:	bl	#0x500031

Function mp_modexp_crt @ 0x004013d5
...
0x004014c1:	movs	r6, r7
0x004014c3:	movs	r0, r0
0x004014c5:	movs	r2, r3
...
Function __memset_chk @ 0x00500025
