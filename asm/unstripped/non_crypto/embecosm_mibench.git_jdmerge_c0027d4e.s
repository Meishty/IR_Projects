...
Function start_pass_merged_upsample @ 0x00400001
...
Function merged_1v_upsample @ 0x00400011
0x00400011:	push	{r3, r4, r5, r6, r7, lr}
0x00400013:	mov	r4, r2
0x00400015:	ldr	r5, [sp, #0x1c]
0x00400017:	ldr.w	r2, [r0, #0x1c0]
...
Function h2v1_merged_upsample @ 0x00400039
0x00400039:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040003d:	mov	r7, r0
0x0040003f:	ldr	r6, [r3]
0x00400041:	ldr	r3, [r1]
...
Function h2v2_merged_upsample @ 0x00400151
...
Function merged_2v_upsample @ 0x004002e1
...
Function jinit_merged_upsampler @ 0x004003ad
0x004003ad:	push	{r3, r4, r5, r6, r7, lr}
0x004003af:	mov	r4, r0
0x004003b1:	ldr	r3, [r0, #4]
0x004003b3:	movs	r2, #0x30
...
0x004004bb:	nop	
0x004004bd:	stc2	p15, c15, [sp], #-0x3fc
0x004004c1:	stc2	p15, c15, [fp], #-0x3fc
0x004004c5:	mcrr2	p15, #0xf, pc, pc, c15
