...
/root/projects/compiled/non_crypto/unstripped/bminor_binutils-gdb.git_vfork-follow-child-exit_906d0abf.o:     file format elf32-littlearm
...
00000000 <f>:
   ...
   6:	1c43      	adds	r3, r0, #1
   8:	d004      	beq.n	14 <f+0x14>
   a:	b108      	cbz	r0, 10 <f+0x10>
   c:	2000      	movs	r0, #0
   e:	bd08      	pop	{r3, pc}
  10:	f7ff fffe 	bl	0 <_exit>
  14:	4802      	ldr	r0, [pc, #8]	; (20 <f+0x20>)
  16:	4478      	add	r0, pc
  18:	f7ff fffe 	bl	0 <perror>
  1c:	2000      	movs	r0, #0
  1e:	bd08      	pop	{r3, pc}
