...
Function fe_pre_emphasis @ 0x00400081
...
Function fe_short_to_double @ 0x004000d9
0x004000d9:	cmp	r2, #0
0x004000db:	ble	#0x4000f7
...
Function fe_create_hamming @ 0x004000f9
0x004000f9:	cmp	r1, #1
...
Function fe_hamming_window @ 0x00400171
0x00400171:	cmp	r2, #1
...
Function fe_mel_spec @ 0x00400191
0x00400191:	vldr	s15, [r0, #0x14]
0x00400195:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400199:	ldr	r7, [r0, #0x2c]
0x0040019b:	vcvt.f32.s32	s15, s15
...
Function fe_mel_cep @ 0x00400221
...
Function fe_spec_magnitude @ 0x004005c9
...
0x00400703:	bl	#0x500061
0x00400707:	movs	r0, #0
0x00400709:	bl	#0x50006d
0x0040070d:	cmp	r4, #0
...
Function fe_frame_to_fea @ 0x0040072d
0x0040072d:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x00400731:	ldr.w	r8, [pc, #0x84]
0x00400735:	ldr	r7, [r0, #0x18]
0x00400737:	add	r8, pc
...
0x004007df:	bl	#0x50003d

Function fe_create_2d @ 0x004007c9
0x004007c9:	push.w	{r3, r4, r5, r6, r7, r8, sb, lr}
0x004007cd:	mov	r8, r1
0x004007cf:	ldr.w	sb, [pc, #0x78]
0x004007d3:	mov	r6, r0
...
0x0040083b:	bl	#0x500061
0x0040083f:	mov	r0, r4
0x00400841:	bl	#0x500055
...
0x00400851:	lsls	r4, r1, #0x1f
0x00400853:	movs	r0, r0
0x00400855:	lsls	r6, r6, #0x1e
...
0x0040086f:	bl	#0x4007c9

Function fe_build_melfilters @ 0x00400859
0x00400859:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040085d:	mov	r4, r0
0x0040085f:	movs	r2, #4
0x00400861:	ldrd	r0, r1, [r0, #8]
...
Function fe_compute_melcosine @ 0x00400ad9
...
0x00400b7d:	bl	#0x500061
0x00400b81:	mov	r0, r4
0x00400b83:	bl	#0x50006d
...
0x00400bab:	b.w	#0x500055
0x00400baf:	bx	lr

Function fe_parse_general_params @ 0x00400bb1
...
Function fe_parse_melfb_params @ 0x00400c45
...
0x00400dcd:	bl	#0x500061
0x00400dd1:	ldr	r0, [r5]
0x00400dd3:	bl	#0x500079
0x00400dd7:	mov	r0, r4
0x00400dd9:	bl	#0x50006d
...
0x00400e11:	lsls	r6, r7, #0x10
0x00400e13:	movs	r0, r0
0x00400e15:	lsls	r2, r2, #0xf
0x00400e17:	movs	r0, r0
0x00400e19:	lsls	r4, r3, #0xd
0x00400e1b:	movs	r0, r0
0x00400e1d:	lsls	r0, r4, #0xc
0x00400e1f:	movs	r0, r0
0x00400e21:	lsls	r2, r0, #0xb
0x00400e23:	movs	r0, r0
0x00400e25:	lsls	r6, r3, #0xb
...
Function fe_print_current @ 0x00400e29
0x00400e29:	ldr	r3, [pc, #0x7c]
0x00400e2b:	movs	r2, #0x17
0x00400e2d:	push	{r4, r5, lr}
0x00400e2f:	mov	r4, r0
...
0x00400ea5:	b.w	#0x500031

Function log10 @ 0x00500001
