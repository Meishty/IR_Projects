...
0x00400035:	lsls	r0, r2, #5
0x00400037:	movs	r0, r0
0x00400039:	lsls	r0, r4, #5
0x0040003b:	movs	r0, r0
0x0040003d:	lsls	r6, r4, #5
0x0040003f:	movs	r0, r0
0x00400041:	lsls	r6, r2, #6
...
Function agcemax_get @ 0x00400045
0x00400045:	ldr	r3, [pc, #0xc]
0x00400047:	add	r3, pc
0x00400049:	vldr	s0, [r3]
0x0040004d:	vcvt.f64.f32	d0, s0
...
Function agc_emax_proc @ 0x00400059
0x00400059:	ldr.w	ip, [pc, #0x48]
0x0040005d:	mov	r3, r0
0x0040005f:	vldr	s15, [r1]
0x00400063:	add	ip, pc
...
0x004000a3:	nop	
0x004000a5:	lsls	r2, r7, #3
0x004000a7:	movs	r0, r0
0x004000a9:	lsls	r0, r5, #3
0x004000ab:	movs	r0, r0
0x004000ad:	lsls	r4, r1, #3
...
Function agc_emax_update @ 0x004000b1
0x004000b1:	ldr	r3, [pc, #0x90]
0x004000b3:	push	{r4, lr}
0x004000b5:	add	r3, pc
0x004000b7:	sub	sp, #8
...
0x00400149:	lsls	r4, r3, #2
0x0040014b:	movs	r0, r0
0x0040014d:	lsls	r4, r5, #1
0x0040014f:	movs	r0, r0
0x00400151:	lsls	r4, r7, #1
0x00400153:	movs	r0, r0
0x00400155:	lsls	r2, r0, #2
0x00400157:	movs	r0, r0
0x00400159:	lsls	r6, r7, #2
0x0040015b:	movs	r0, r0
0x0040015d:	movs	r6, r7
0x0040015f:	movs	r0, r0

Function _E__pr_info_header @ 0x00500001
...
Function _E__pr_info @ 0x0050000d
