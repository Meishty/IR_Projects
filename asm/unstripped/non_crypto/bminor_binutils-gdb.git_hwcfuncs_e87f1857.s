...
Function hwcdrv_get_info @ 0x00400009
0x00400009:	bx	lr
...
Function hwcdrv_enable_mt @ 0x0040000d
0x0040000d:	mov.w	r0, #-1
0x00400011:	bx	lr
...
Function hwcdrv_get_descriptions @ 0x00400015
0x00400015:	movs	r0, #0
0x00400017:	bx	lr

Function hwcdrv_assign_regnos @ 0x00400019
...
Function hwcdrv_create_counters @ 0x00400021
0x00400021:	mov.w	r0, #-1
0x00400025:	bx	lr
...
Function hwcdrv_read_events @ 0x00400029
0x00400029:	mov.w	r0, #-1
0x0040002d:	bx	lr
...
Function hwcdrv_start @ 0x00400031
0x00400031:	mov.w	r0, #-1
0x00400035:	bx	lr
...
Function hwcdrv_overflow @ 0x00400039
0x00400039:	movs	r0, #0
0x0040003b:	bx	lr

Function hwcdrv_sighlr_restart @ 0x0040003d
...
Function hwcdrv_free_counters @ 0x00400045
0x00400045:	movs	r0, #0
0x00400047:	bx	lr

Function hwcdrv_lwp_fini @ 0x00400049
0x00400049:	bx	lr
...
Function hwcdrv_lwp_init @ 0x0040004d
0x0040004d:	movs	r0, #0
0x0040004f:	bx	lr

Function hwcdrv_lwp_suspend @ 0x00400051
...
Function hwcdrv_lwp_resume @ 0x00400059
0x00400059:	mov.w	r0, #-1
0x0040005d:	bx	lr
...
Function hwcfuncs_errmsg_get @ 0x00400061
0x00400061:	push	{r3, r4, r5, r6, r7, lr}
0x00400063:	movs	r7, #0
0x00400065:	ldr	r3, [pc, #0x40]
0x00400067:	mov	r6, r2
...
0x004000a7:	nop	
0x004000a9:	lsrs	r2, r3, #9
0x004000ab:	movs	r0, r0
0x004000ad:	lsrs	r2, r2, #9
0x004000af:	movs	r0, r0
0x004000b1:	lsrs	r2, r0, #9
0x004000b3:	movs	r0, r0
0x004000b5:	lsrs	r0, r7, #8
...
Function hwcfuncs_int_logerr @ 0x004000b9
0x004000b9:	push	{r0, r1, r2, r3}
0x004000bb:	movs	r0, #0
0x004000bd:	push	{r4, r5, r6, lr}
0x004000bf:	sub	sp, #8
...
Function hwcfuncs_parse_attrs @ 0x0040011d
...
0x004002e1:	bl	#0x500085

Function hwcfuncs_parse_ctr @ 0x00400305
...
0x004003eb:	b.w	#0x500079
0x004003ef:	movs	r1, #0x2f
0x004003f1:	mov	r0, r8
0x004003f3:	bl	#0x500049
...
Function hwcfuncs_bind_descriptor @ 0x00400425
0x00400425:	ldr	r2, [pc, #0x39c]
0x00400427:	ldr	r3, [pc, #0x3a0]
0x00400429:	add	r2, pc
0x0040042b:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
...
0x00400837:	bl	#0x50009d

Function hwcfuncs_bind_hwcentry @ 0x0040080d
0x0040080d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400811:	mov	r7, r0
0x00400813:	ldr.w	r8, [pc, #0x1c0]
0x00400817:	ldr.w	fp, [pc, #0x1c0]
...
0x004009d3:	nop	
0x004009d5:	lsls	r0, r6, #0xa
0x004009d7:	movs	r0, r0
0x004009d9:	asrs	r0, r6, #3
0x004009db:	movs	r0, r0
0x004009dd:	lsrs	r6, r5, #0x1f
0x004009df:	movs	r0, r0
0x004009e1:	lsrs	r4, r5, #0x1f
0x004009e3:	movs	r0, r0
0x004009e5:	lsls	r2, r5, #7
0x004009e7:	movs	r0, r0
0x004009e9:	lsrs	r4, r3, #0x1f
0x004009eb:	movs	r0, r0
0x004009ed:	lsrs	r6, r7, #0x1a
0x004009ef:	movs	r0, r0
0x004009f1:	lsrs	r2, r2, #0x1e
0x004009f3:	movs	r0, r0
0x004009f5:	lsls	r4, r6, #6
0x004009f7:	movs	r0, r0
0x004009f9:	lsrs	r6, r7, #0x1e
0x004009fb:	movs	r0, r0
0x004009fd:	asrs	r6, r6, #0x20
0x004009ff:	movs	r0, r0
0x00400a01:	lsls	r4, r1, #6
0x00400a03:	movs	r0, r0
0x00400a05:	lsrs	r4, r7, #0x14
0x00400a07:	movs	r0, r0
0x00400a09:	lsrs	r4, r4, #0x1b
0x00400a0b:	movs	r0, r0
0x00400a0d:	lsls	r6, r5, #4
0x00400a0f:	movs	r0, r0
0x00400a11:	lsrs	r4, r5, #0x13
...
Function hwcfuncs_get_ctrs @ 0x00400a15
0x00400a15:	cbz	r0, #0x400a21
0x00400a17:	ldr	r3, [pc, #0x14]
0x00400a19:	add	r3, pc
0x00400a1b:	ldr.w	r3, [r3, #0xb88]
...
0x00400a2b:	nop	
0x00400a2d:	lsls	r4, r6, #2
0x00400a2f:	movs	r0, r0
0x00400a31:	lsls	r2, r5, #2
...
Function get_hwcdrv @ 0x00400a35
0x00400a35:	ldr	r1, [pc, #0x78]
0x00400a37:	ldr.w	ip, [pc, #0x7c]
0x00400a3b:	add	r1, pc
0x00400a3d:	add	ip, pc
...
Function __vsnprintf_chk @ 0x00500025
