...
0x00400023:	adds	r2, r0, #1
0x00400025:	mov	r4, r0
0x00400027:	mov	r0, r2
0x00400029:	subs	r4, #1
0x0040002b:	str	r2, [sp]
0x0040002d:	bl	#0x50000d
0x00400031:	mov	r5, r0
0x00400033:	ldrd	r2, r1, [sp]
0x00400037:	bl	#0x500019
0x0040003b:	ldrb	r3, [r5, r4]
0x0040003d:	movs	r2, #0
0x0040003f:	mov	r1, r5
0x00400041:	mov	r0, r5
0x00400043:	cmp	r3, #0x31
0x00400045:	itt	eq
0x00400047:	moveq	r3, #0x32
0x00400049:	strbeq	r3, [r5, r4]
