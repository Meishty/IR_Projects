...
Function rop4 @ 0x0040001d
0x0040001d:	orrs	r0, r2
0x0040001f:	bic.w	r0, r1, r0
0x00400023:	bx	lr

Function rop5 @ 0x00400025
...
Function rop6 @ 0x0040002d
0x0040002d:	eors	r0, r1
0x0040002f:	bic.w	r0, r0, r2
0x00400033:	bx	lr

Function rop7 @ 0x00400035
...
Function rop8 @ 0x00400041
0x00400041:	ands	r0, r1
0x00400043:	bic.w	r0, r0, r2
0x00400047:	bx	lr

Function rop9 @ 0x00400049
...
Function rop13 @ 0x00400071
0x00400071:	bic.w	r1, r0, r1
0x00400075:	orr.w	r0, r1, r2
0x00400079:	mvns	r0, r0
0x0040007b:	bx	lr

Function rop14 @ 0x0040007d
0x0040007d:	orrs	r0, r1
0x0040007f:	bic.w	r0, r0, r2
0x00400083:	bx	lr

Function rop15 @ 0x00400085
0x00400085:	mvns	r0, r2
0x00400087:	bx	lr

Function rop16 @ 0x00400089
0x00400089:	orrs	r0, r1
0x0040008b:	bic.w	r0, r2, r0
0x0040008f:	bx	lr

Function rop17 @ 0x00400091
...
Function rop18 @ 0x00400099
0x00400099:	eors	r0, r2
0x0040009b:	bic.w	r0, r0, r1
0x0040009f:	bx	lr

Function rop19 @ 0x004000a1
...
Function rop20 @ 0x004000ad
0x004000ad:	eors	r1, r2
0x004000af:	bic.w	r0, r1, r0
0x004000b3:	bx	lr

Function rop21 @ 0x004000b5
0x004000b5:	ands	r1, r2
0x004000b7:	orrs	r0, r1
0x004000b9:	mvns	r0, r0
0x004000bb:	bx	lr

Function rop22 @ 0x004000bd
...
Function rop26 @ 0x004000ed
0x004000ed:	ands	r1, r2
0x004000ef:	orrs	r0, r1
0x004000f1:	eors	r0, r2
0x004000f3:	bx	lr

Function rop27 @ 0x004000f5
...
Function rop28 @ 0x00400101
0x00400101:	and.w	r3, r0, r2
0x00400105:	orrs	r1, r3
0x00400107:	eor.w	r0, r1, r2
0x0040010b:	bx	lr

Function rop29 @ 0x0040010d
...
Function rop32 @ 0x0040012d
0x0040012d:	ands	r0, r2
0x0040012f:	bic.w	r0, r0, r1
0x00400133:	bx	lr

Function rop33 @ 0x00400135
...
Function rop36 @ 0x00400155
0x00400155:	eors	r2, r1
0x00400157:	eors	r0, r1
0x00400159:	ands	r0, r2
0x0040015b:	bx	lr

Function rop37 @ 0x0040015d
...
Function rop38 @ 0x00400169
0x00400169:	ands	r2, r1
0x0040016b:	orrs	r0, r2
0x0040016d:	eors	r0, r1
0x0040016f:	bx	lr

Function rop39 @ 0x00400171
...
Function rop42 @ 0x00400195
0x00400195:	ands	r1, r2
0x00400197:	bic.w	r0, r0, r1
0x0040019b:	bx	lr

Function rop43 @ 0x0040019d
...
Function rop62 @ 0x00400265
0x00400265:	bic.w	r3, r0, r1
0x00400269:	orrs	r2, r3
0x0040026b:	eor.w	r0, r2, r1
0x0040026f:	bx	lr

Function rop63 @ 0x00400271
...
Function rop70 @ 0x004002b5
0x004002b5:	ands	r2, r0
0x004002b7:	orrs	r2, r1
0x004002b9:	eors	r0, r2
0x004002bb:	bx	lr

Function rop71 @ 0x004002bd
...
Function rop74 @ 0x004002e1
0x004002e1:	orrs	r1, r0
0x004002e3:	ands	r1, r2
0x004002e5:	eors	r0, r1
0x004002e7:	bx	lr

Function rop75 @ 0x004002e9
0x004002e9:	orn	r0, r0, r1
0x004002ed:	eors	r0, r2
0x004002ef:	bx	lr

Function rop76 @ 0x004002f1
0x004002f1:	ands	r0, r2
0x004002f3:	bic.w	r0, r1, r0
0x004002f7:	bx	lr

Function rop77 @ 0x004002f9
...
Function rop82 @ 0x0040032d
0x0040032d:	ands	r1, r0
0x0040032f:	orrs	r1, r2
0x00400331:	eors	r0, r1
0x00400333:	bx	lr

Function rop83 @ 0x00400335
...
Function rop84 @ 0x00400341
0x00400341:	orrs	r1, r2
0x00400343:	bic.w	r0, r1, r0
0x00400347:	bx	lr

Function rop85 @ 0x00400349
0x00400349:	mvns	r0, r0
0x0040034b:	bx	lr

Function rop86 @ 0x0040034d
...
Function rop92 @ 0x0040037d
0x0040037d:	eors	r1, r0
0x0040037f:	orrs	r1, r2
0x00400381:	eors	r0, r1
0x00400383:	bx	lr

Function rop93 @ 0x00400385
...
Function rop105 @ 0x004003fd
0x004003fd:	eors	r2, r1
0x004003ff:	eors	r0, r2
0x00400401:	mvns	r0, r0
0x00400403:	bx	lr

Function rop106 @ 0x00400405
...
Function rop111 @ 0x00400441
0x00400441:	eors	r0, r1
0x00400443:	orn	r0, r0, r2
0x00400447:	bx	lr

Function rop112 @ 0x00400449
0x00400449:	ands	r0, r1
0x0040044b:	bic.w	r0, r2, r0
0x0040044f:	bx	lr

Function rop113 @ 0x00400451
...
Function rop130 @ 0x00400501
0x00400501:	eors	r1, r2
0x00400503:	bic.w	r0, r0, r1
0x00400507:	bx	lr

Function rop131 @ 0x00400509
...
Function rop132 @ 0x00400515
0x00400515:	eors	r0, r2
0x00400517:	bic.w	r0, r1, r0
0x0040051b:	bx	lr

Function rop133 @ 0x0040051d
...
Function rop136 @ 0x00400541
0x00400541:	ands	r0, r1
0x00400543:	bx	lr

Function rop137 @ 0x00400545
...
Function rop138 @ 0x00400551
0x00400551:	orn	r2, r1, r2
0x00400555:	ands	r0, r2
0x00400557:	bx	lr

Function rop139 @ 0x00400559
...
Function rop140 @ 0x00400565
0x00400565:	orn	r0, r0, r2
0x00400569:	ands	r0, r1
0x0040056b:	bx	lr

Function rop141 @ 0x0040056d
...
Function rop154 @ 0x004005f5
0x004005f5:	bic.w	r1, r2, r1
0x004005f9:	eors	r0, r1
0x004005fb:	bx	lr

Function rop155 @ 0x004005fd
...
Function rop156 @ 0x00400609
0x00400609:	bic.w	r0, r2, r0
0x0040060d:	eors	r0, r1
0x0040060f:	bx	lr

Function rop157 @ 0x00400611
...
Function rop160 @ 0x00400635
0x00400635:	ands	r0, r2
0x00400637:	bx	lr

Function rop161 @ 0x00400639
...
Function rop162 @ 0x00400645
0x00400645:	orn	r1, r2, r1
0x00400649:	ands	r0, r1
0x0040064b:	bx	lr

Function rop163 @ 0x0040064d
...
Function rop166 @ 0x0040066d
0x0040066d:	bic.w	r2, r1, r2
0x00400671:	eors	r0, r2
0x00400673:	bx	lr

Function rop167 @ 0x00400675
...
Function rop169 @ 0x00400689
0x00400689:	orrs	r2, r1
0x0040068b:	eors	r0, r2
0x0040068d:	mvns	r0, r0
0x0040068f:	bx	lr

Function rop170 @ 0x00400691
0x00400691:	bx	lr
...
Function rop171 @ 0x00400695
0x00400695:	orrs	r2, r1
0x00400697:	orn	r0, r0, r2
0x0040069b:	bx	lr

Function rop172 @ 0x0040069d
0x0040069d:	eor.w	r3, r1, r0
0x004006a1:	ands	r2, r3
0x004006a3:	eor.w	r0, r2, r1
0x004006a7:	bx	lr

Function rop173 @ 0x004006a9
...
Function rop174 @ 0x004006b5
0x004006b5:	bic.w	r2, r1, r2
0x004006b9:	orrs	r0, r2
0x004006bb:	bx	lr

Function rop175 @ 0x004006bd
...
Function rop176 @ 0x004006c5
0x004006c5:	orn	r0, r0, r1
0x004006c9:	ands	r0, r2
0x004006cb:	bx	lr

Function rop177 @ 0x004006cd
...
Function rop179 @ 0x004006e5
0x004006e5:	ands	r0, r2
0x004006e7:	orn	r0, r0, r1
0x004006eb:	bx	lr

Function rop180 @ 0x004006ed
0x004006ed:	bic.w	r0, r1, r0
0x004006f1:	eors	r0, r2
0x004006f3:	bx	lr

Function rop181 @ 0x004006f5
...
Function rop186 @ 0x0040072d
0x0040072d:	bic.w	r1, r2, r1
0x00400731:	orrs	r0, r1
0x00400733:	bx	lr

Function rop187 @ 0x00400735
...
Function rop191 @ 0x0040075d
0x0040075d:	ands	r2, r1
0x0040075f:	orn	r0, r0, r2
0x00400763:	bx	lr

Function rop192 @ 0x00400765
...
Function rop196 @ 0x00400791
0x00400791:	orn	r0, r2, r0
0x00400795:	ands	r0, r1
0x00400797:	bx	lr

Function rop197 @ 0x00400799
...
Function rop198 @ 0x004007a5
0x004007a5:	bic.w	r0, r0, r2
0x004007a9:	eors	r0, r1
0x004007ab:	bx	lr

Function rop199 @ 0x004007ad
...
Function rop202 @ 0x004007cd
0x004007cd:	eors	r1, r0
0x004007cf:	ands	r1, r2
0x004007d1:	eors	r0, r1
0x004007d3:	bx	lr

Function rop203 @ 0x004007d5
...
Function rop204 @ 0x004007e1
0x004007e1:	mov	r0, r1
0x004007e3:	bx	lr

Function rop205 @ 0x004007e5
0x004007e5:	orrs	r0, r2
0x004007e7:	orn	r0, r1, r0
0x004007eb:	bx	lr

Function rop206 @ 0x004007ed
0x004007ed:	bic.w	r0, r0, r2
0x004007f1:	orrs	r0, r1
0x004007f3:	bx	lr

Function rop207 @ 0x004007f5
...
Function rop208 @ 0x004007fd
0x004007fd:	orn	r0, r1, r0
0x00400801:	ands	r0, r2
0x00400803:	bx	lr

Function rop209 @ 0x00400805
...
Function rop210 @ 0x00400811
0x00400811:	bic.w	r0, r0, r1
0x00400815:	eors	r0, r2
0x00400817:	bx	lr

Function rop211 @ 0x00400819
...
Function rop213 @ 0x00400835
0x00400835:	ands	r2, r1
0x00400837:	orn	r0, r2, r0
0x0040083b:	bx	lr

Function rop214 @ 0x0040083d
...
Function rop220 @ 0x0040087d
0x0040087d:	bic.w	r0, r2, r0
0x00400881:	orrs	r0, r1
0x00400883:	bx	lr

Function rop221 @ 0x00400885
...
Function rop223 @ 0x00400895
0x00400895:	ands	r0, r2
0x00400897:	orn	r0, r1, r0
0x0040089b:	bx	lr

Function rop224 @ 0x0040089d
...
Function rop225 @ 0x004008a5
0x004008a5:	orrs	r0, r1
0x004008a7:	eors	r0, r2
0x004008a9:	mvns	r0, r0
0x004008ab:	bx	lr

Function rop226 @ 0x004008ad
0x004008ad:	eors	r2, r0
0x004008af:	ands	r2, r1
0x004008b1:	eors	r0, r2
0x004008b3:	bx	lr

Function rop227 @ 0x004008b5
...
Function rop228 @ 0x004008c1
0x004008c1:	eors	r2, r1
0x004008c3:	ands	r0, r2
0x004008c5:	eors	r0, r1
0x004008c7:	bx	lr

Function rop229 @ 0x004008c9
...
Function rop235 @ 0x00400911
0x00400911:	eors	r2, r1
0x00400913:	orn	r0, r0, r2
0x00400917:	bx	lr

Function rop236 @ 0x00400919
...
Function rop237 @ 0x00400921
0x00400921:	eors	r0, r2
0x00400923:	orn	r0, r1, r0
0x00400927:	bx	lr

Function rop238 @ 0x00400929
0x00400929:	orrs	r0, r1
0x0040092b:	bx	lr

Function rop239 @ 0x0040092d
0x0040092d:	orrs	r0, r1
0x0040092f:	orn	r0, r0, r2
0x00400933:	bx	lr

Function rop240 @ 0x00400935
0x00400935:	mov	r0, r2
0x00400937:	bx	lr

Function rop241 @ 0x00400939
0x00400939:	orrs	r0, r1
0x0040093b:	orn	r0, r2, r0
0x0040093f:	bx	lr

Function rop242 @ 0x00400941
0x00400941:	bic.w	r0, r0, r1
0x00400945:	orrs	r0, r2
0x00400947:	bx	lr

Function rop243 @ 0x00400949
...
Function rop244 @ 0x00400951
0x00400951:	bic.w	r0, r1, r0
0x00400955:	orrs	r0, r2
0x00400957:	bx	lr

Function rop245 @ 0x00400959
...
Function rop247 @ 0x00400969
0x00400969:	ands	r0, r1
0x0040096b:	orn	r0, r2, r0
0x0040096f:	bx	lr

Function rop248 @ 0x00400971
...
Function rop249 @ 0x00400979
0x00400979:	eors	r0, r1
0x0040097b:	orn	r0, r2, r0
0x0040097f:	bx	lr

Function rop250 @ 0x00400981
0x00400981:	orrs	r0, r2
0x00400983:	bx	lr

Function rop251 @ 0x00400985
0x00400985:	orrs	r0, r2
0x00400987:	orn	r0, r0, r1
0x0040098b:	bx	lr

Function rop252 @ 0x0040098d
...
Function rop253 @ 0x00400995
0x00400995:	orrs	r2, r1
0x00400997:	orn	r0, r2, r0
0x0040099b:	bx	lr

Function rop254 @ 0x0040099d
