...
Function get_8bit_row @ 0x00400025
...
Function get_16bit_row @ 0x00400069
...
Function get_24bit_row @ 0x004000c1
...
Function get_memory_row @ 0x00400101
0x00400101:	push	{r4, r5, lr}
0x00400103:	mov	r4, r1
0x00400105:	ldr	r1, [r0, #0x1c]
0x00400107:	sub	sp, #0xc
...
Function preload_image @ 0x0040012d
0x0040012d:	ldr	r2, [r0, #0x1c]
0x0040012f:	push.w	{r4, r5, r6, r7, r8, sb, lr}
0x00400133:	mov	r4, r0
0x00400135:	ldr	r7, [r0, #8]
...
Function finish_input_tga @ 0x004001ed
0x004001ed:	bx	lr
...
Function read_non_rle_pixel @ 0x004001f1
0x004001f1:	ldr	r3, [r0, #0x30]
0x004001f3:	cmp	r3, #0
0x004001f5:	ble	#0x400219
0x004001f7:	push	{r4, r5, r6, lr}
0x004001f9:	mov	r4, r0
0x004001fb:	ldr	r6, [r0, #0xc]
0x004001fd:	add.w	r5, r0, #0x2b
...
Function read_rle_pixel @ 0x0040021d
0x0040021d:	ldr	r3, [r0, #0x38]
0x0040021f:	push	{r4, r5, r6, lr}
0x00400221:	mov	r4, r0
0x00400223:	cmp	r3, #0
...
Function start_input_tga @ 0x00400291
0x00400291:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400295:	mov	r4, r1
0x00400297:	ldr	r5, [pc, #0x32c]
0x00400299:	ldr	r3, [pc, #0x32c]
...
0x004005c1:	bl	#0x500019

Function jinit_read_targa @ 0x004005ed
...
0x0040060b:	nop	
0x0040060d:	stc2	p15, c15, [pc], {0xff}
