...
Function put4bitcmaptile @ 0x00400155
...
Function put2bitcmaptile @ 0x004001f9
...
Function put1bitcmaptile @ 0x004002a9
...
Function putgreytile @ 0x0040039d
0x0040039d:	push	{r4, r5, r6, r7, lr}
0x0040039f:	ldr	r5, [sp, #0x24]
0x004003a1:	ldrd	r3, r2, [sp, #0x14]
0x004003a5:	ldr	r4, [r0, #0x38]
...
Function put1bitbwtile @ 0x004003e5
...
Function put2bitbwtile @ 0x004004d9
0x004004d9:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004004dd:	ldr	r7, [sp, #0x24]
0x004004df:	ldrd	r2, r3, [sp, #0x28]
0x004004e3:	ldr	r4, [r0, #0x38]
...
Function put4bitbwtile @ 0x00400589
...
Function putRGBcontig8bittile @ 0x0040062d
...
Function putRGBcontig8bitMaptile @ 0x00400915
0x00400915:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x00400919:	ldrh.w	lr, [r0, #0x1a]
0x0040091d:	ldrd	r7, r2, [sp, #0x24]
0x00400921:	ldr	r3, [sp, #0x20]
...
Function putRGBAAcontig8bittile @ 0x00400985
...
Function putRGBUAcontig8bittile @ 0x00400abd
0x00400abd:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400ac1:	ldrh	r7, [r0, #0x1a]
0x00400ac3:	sub	sp, #0xc
0x00400ac5:	ldrd	r4, r2, [sp, #0x34]
...
Function putRGBcontig16bittile @ 0x00400b51
0x00400b51:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x00400b55:	ldrh.w	lr, [r0, #0x1a]
0x00400b59:	ldrd	r6, r3, [sp, #0x24]
0x00400b5d:	ldr	r7, [sp, #0x20]
...
Function putRGBAAcontig16bittile @ 0x00400bbd
...
Function putRGBUAcontig16bittile @ 0x00400c31
...
Function putRGBcontig8bitCMYKtile @ 0x00400cc9
...
Function putRGBcontig8bitCMYKMaptile @ 0x004012f5
...
Function putRGBseparate8bittile @ 0x004013b9
0x004013b9:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004013bd:	sub	sp, #0x1c
0x004013bf:	ldrd	r3, fp, [sp, #0x44]
0x004013c3:	ldrd	r6, r7, [sp, #0x50]
...
Function putRGBseparate8bitMaptile @ 0x00401629
0x00401629:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040162d:	ldr	r0, [r0, #0x34]
0x0040162f:	sub	sp, #0xc
0x00401631:	ldrd	r5, r3, [sp, #0x30]
...
Function putRGBAAseparate8bittile @ 0x004016a1
...
Function putRGBUAseparate8bittile @ 0x00401985
...
Function putRGBseparate16bittile @ 0x00401a3d
0x00401a3d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00401a41:	sub	sp, #0xc
0x00401a43:	ldrd	r5, r3, [sp, #0x30]
0x00401a47:	ldrd	r8, sb, [sp, #0x40]
...
Function putRGBAAseparate16bittile @ 0x00401aad
...
Function putRGBUAseparate16bittile @ 0x00401b41
...
Function putcontig8bitYCbCr44tile @ 0x00401bf5
0x00401bf5:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00401bf9:	mov	r5, r1
0x00401bfb:	sub	sp, #0x34
0x00401bfd:	ldr	r4, [sp, #0x64]
...
Function putcontig8bitYCbCr42tile @ 0x00401f89
...
Function putcontig8bitYCbCr41tile @ 0x0040218d
...
Function putcontig8bitYCbCr22tile @ 0x004022cd
...
Function putcontig8bitYCbCr21tile @ 0x00402429
0x00402429:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040242d:	ldr	r3, [r0, #0x40]
0x0040242f:	sub	sp, #0x1c
0x00402431:	ldrd	r8, sl, [r3, #4]
...
Function putcontig8bitYCbCr11tile @ 0x00402509
0x00402509:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040250d:	mov	lr, r1
0x0040250f:	ldr	r2, [r0, #0x40]
0x00402511:	sub	sp, #0x14
...
Function gtTileSeparate @ 0x004025a5
0x004025a5:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004025a9:	mov	fp, r2
0x004025ab:	ldr	r2, [pc, #0x284]
0x004025ad:	vpush	{d8}
...
0x0040286b:	bl	#0x500079

Function TIFFYCbCrToRGBInit @ 0x00402849
0x00402849:	push.w	{r4, r5, r6, r7, r8, lr}
0x0040284d:	mov	r4, r0
0x0040284f:	ldr	r6, [pc, #0x164]
0x00402851:	ldr	r3, [pc, #0x164]
...
0x004029ad:	bl	#0x50006d

Function buildMap @ 0x004029c1
...
0x0040301d:	bl	#0x500025
0x00403021:	ldr	r1, [pc, #0x14]
0x00403023:	add	r1, pc
0x00403025:	bl	#0x500061
0x00403029:	mov	r0, r7
0x0040302b:	b	#0x402a37

Function sub_402e79 @ 0x00402e79
0x00402e79:	lsls	r3, r5, #0x11
0x00402e7b:	ldr	r6, [pc, #0xe4]
0x00402e7d:	subs	r1, #0x39
0x00402e7f:	add	r1, r7
...
Function sub_402f15 @ 0x00402f15
...
Function TIFFRGBAImageBegin.part.0 @ 0x0040303d
...
Function gtStripContig @ 0x00403809
...
0x00403877:	bl	#0x500085
0x0040386f:	add	r2, sp, #0x30
0x00403871:	mov.w	r1, #0x116
0x00403875:	mov	r0, fp
0x00403877:	bl	#0x500085
0x0040387b:	mov	r0, fp
0x0040387d:	bl	#0x5000f1
...
0x00403a0d:	bl	#0x500001

Function gtTileContig @ 0x004039e5
0x004039e5:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004039e9:	mov	r6, r2
0x004039eb:	ldr	r2, [pc, #0x1a4]
0x004039ed:	sub	sp, #0x44
...
0x00403bd7:	bl	#0x5000e5

Function gtStripSeparate @ 0x00403ba9
0x00403ba9:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00403bad:	mov	sb, r0
0x00403baf:	ldr	r4, [r0]
0x00403bb1:	sub	sp, #0x5c
...
Function TIFFRGBAImageOK @ 0x00403de9
0x00403de9:	ldr	r2, [pc, #0x1f0]
0x00403deb:	ldr	r3, [pc, #0x1f4]
0x00403ded:	add	r2, pc
0x00403def:	push	{r4, r5, r6, r7, lr}
...
0x004040b7:	bl	#0x500085

Function TIFFRGBAImageBegin @ 0x00404091
0x00404091:	push	{r4, r5, r6, r7, lr}
0x00404093:	mov	r4, r0
0x00404095:	mov	r6, r1
0x00404097:	movs	r5, #0
...
Function TIFFRGBAImageGet @ 0x00404105
...
0x004041af:	bl	#0x5000b5
0x004041b3:	mov	r0, r6
0x004041b5:	movs	r5, #0
0x004041b7:	bl	#0x500025
0x004041bb:	mov	r1, sb
0x004041bd:	bl	#0x500061
...
0x004042c1:	bl	#0x5000a9

Function TIFFReadRGBAStrip @ 0x004042a1
0x004042a1:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x004042a5:	mov	sb, r2
0x004042a7:	ldr	r2, [pc, #0x180]
0x004042a9:	ldr	r3, [pc, #0x180]
...
0x004042d7:	bl	#0x500085
0x004042db:	ldr.w	r1, [r8]
0x004042df:	mov	r0, r7
0x004042e1:	bl	#0x500115
0x004042e5:	cmp	r1, #0
...
0x0040432f:	bl	#0x5000b5
0x00404333:	mov	r0, r6
0x00404335:	bl	#0x500025
0x00404339:	mov	r1, sl
0x0040433b:	bl	#0x500061
...
0x00404607:	bl	#0x500049
0x00404601:	ldr.w	r0, [sl, #0x20]
0x00404605:	cbz	r0, #0x40461b
0x00404607:	bl	#0x500049
0x00404607:	bl	#0x500049
0x0040460b:	ldr.w	r0, [sl, #0x24]
0x0040460f:	bl	#0x500049
0x00404613:	ldr.w	r0, [sl, #0x28]
0x00404617:	bl	#0x500049
...
Function TIFFGetField @ 0x00500019
...
Function TIFFFileName @ 0x00500025
...
Function TIFFWarning @ 0x00500031
...
Function TIFFReadTile @ 0x0050003d
...
Function _TIFFmemset @ 0x00500079
...
Function TIFFGetFieldDefaulted @ 0x00500085
...
Function _TIFFmemcpy @ 0x00500091
...
Function __aeabi_idiv @ 0x0050009d
...
Function TIFFIsTiled @ 0x005000a9
...
Function TIFFSetField @ 0x005000cd
...
Function _TIFFmemcmp @ 0x005000d9
...
Function TIFFStripSize @ 0x005000e5
...
Function TIFFScanlineSize @ 0x005000f1
...
Function TIFFComputeStrip @ 0x005000fd
...
Function TIFFReadEncodedStrip @ 0x00500109
...
Function __aeabi_uidivmod @ 0x00500115
