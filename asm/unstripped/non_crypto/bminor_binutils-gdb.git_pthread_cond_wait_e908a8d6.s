...
/root/projects/compiled/non_crypto/unstripped/bminor_binutils-gdb.git_pthread_cond_wait_e908a8d6.o:     file format elf32-littlearm
...
00000000 <main>:
   0:	b500      	push	{lr}
   2:	2300      	movs	r3, #0
   4:	f8df e02c 	ldr.w	lr, [pc, #44]	; 34 <main+0x34>
   8:	f8df c02c 	ldr.w	ip, [pc, #44]	; 38 <main+0x38>
   c:	b083      	sub	sp, #12
   e:	44fe      	add	lr, pc
  10:	4a0a      	ldr	r2, [pc, #40]	; (3c <main+0x3c>)
  12:	4619      	mov	r1, r3
  14:	4668      	mov	r0, sp
  16:	447a      	add	r2, pc
