...
Function Luv32fromLuv48 @ 0x00400099
...
Function _logLuvNop @ 0x004000e5
0x004000e5:	bx	lr
...
Function LogLuvClose @ 0x004000e9
0x004000e9:	ldrh.w	r3, [r0, #0x46]
0x004000ed:	movs	r2, #0x10
0x004000ef:	movt	r2, #2
0x004000f3:	movw	r1, #0x804c
...
Function LogLuvVGetField @ 0x00400109
0x00400109:	mov.w	ip, #0x18
0x0040010d:	movt	ip, #1
0x00400111:	push	{r4}
0x00400113:	cmp	r1, ip
...
Function LogLuvVSetField @ 0x00400131
...
Function LogLuvCleanup @ 0x004001a9
...
Function LogL16Encode @ 0x0040035d
...
0x004005b3:	nop	
0x004005b5:	movs	r2, #0xa8
0x004005b7:	movs	r0, r0
0x004005b9:	subs	r6, r4, #4
0x004005bb:	movs	r0, r0
0x004005bd:	subs	r4, r4, #5
0x004005bf:	movs	r0, r0
0x004005c1:	movs	r2, #0x90
0x004005c3:	movs	r0, r0
0x004005c5:	subs	r6, r1, #4
0x004005c7:	movs	r0, r0
0x004005c9:	subs	r0, r4, #5
0x004005cb:	movs	r0, r0
0x004005cd:	movs	r2, #0x78
0x004005cf:	movs	r0, r0
0x004005d1:	subs	r6, r6, #3
0x004005d3:	movs	r0, r0
0x004005d5:	subs	r4, r7, #4
...
Function LogLuvEncode32 @ 0x004005d9
0x004005d9:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004005dd:	mov	fp, r0
0x004005df:	ldr.w	r4, [r0, #0x1c4]
0x004005e3:	sub	sp, #0xc
...
0x0040081f:	bl	#0x500061

Function sub_400823 @ 0x00400823
0x00400823:	nop	
0x00400825:	movs	r0, #0x38
0x00400827:	movs	r0, r0
0x00400829:	adds	r6, r6, #2
0x0040082b:	movs	r0, r0
0x0040082d:	adds	r4, r6, #3
0x0040082f:	movs	r0, r0
0x00400831:	movs	r0, #0x20
0x00400833:	movs	r0, r0
0x00400835:	adds	r6, r3, #2
0x00400837:	movs	r0, r0
0x00400839:	adds	r0, r6, #3
0x0040083b:	movs	r0, r0
0x0040083d:	movs	r0, #8
0x0040083f:	movs	r0, r0
0x00400841:	adds	r6, r0, #2
0x00400843:	movs	r0, r0
0x00400845:	adds	r4, r1, #3
...
Function LogLuvEncode24 @ 0x00400849
0x00400849:	push	{r3, r4, r5, r6, r7, lr}
0x0040084b:	mov	r6, r0
0x0040084d:	ldr.w	r7, [r0, #0x1c4]
0x00400851:	cmp	r3, #0
...
0x00400937:	bl	#0x500061

Function sub_40093b @ 0x0040093b
0x0040093b:	nop	
0x0040093d:	subs	r0, r4, #4
0x0040093f:	movs	r0, r0
0x00400941:	subs	r6, r3, r6
0x00400943:	movs	r0, r0
0x00400945:	subs	r0, r6, r7
0x00400947:	movs	r0, r0
0x00400949:	subs	r0, r1, #4
0x0040094b:	movs	r0, r0
0x0040094d:	subs	r6, r0, r6
0x0040094f:	movs	r0, r0
0x00400951:	subs	r4, r1, r7
0x00400953:	movs	r0, r0
0x00400955:	subs	r0, r6, #3
0x00400957:	movs	r0, r0
0x00400959:	subs	r6, r5, r5
0x0040095b:	movs	r0, r0
0x0040095d:	subs	r4, r5, r6
...
Function Luv32toRGB @ 0x00400961
0x00400961:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400965:	cmp	r2, #0
0x00400967:	ldr	r7, [r0, #8]
0x00400969:	vpush	{d8, d9, d10, d11, d12, d13, d14, d15}
...
Function LogL16Decode @ 0x00400c51
...
0x00400e1b:	nop	
0x00400e1d:	asrs	r0, r0, #0x1d
0x00400e1f:	movs	r0, r0
0x00400e21:	subs	r4, r7, r0
0x00400e23:	movs	r0, r0
0x00400e25:	asrs	r2, r7, #0x1a
0x00400e27:	movs	r0, r0
0x00400e29:	asrs	r4, r1, #0x1c
0x00400e2b:	movs	r0, r0
0x00400e2d:	subs	r6, r4, r0
0x00400e2f:	movs	r0, r0
0x00400e31:	asrs	r4, r4, #0x1a
0x00400e33:	movs	r0, r0
0x00400e35:	asrs	r2, r5, #0x1b
0x00400e37:	movs	r0, r0
0x00400e39:	subs	r0, r2, r0
0x00400e3b:	movs	r0, r0
0x00400e3d:	asrs	r6, r1, #0x1a
0x00400e3f:	movs	r0, r0
0x00400e41:	asrs	r4, r1, #0x1b
...
Function LogLuvDecode32 @ 0x00400e45
0x00400e45:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400e49:	sub	sp, #0x1c
0x00400e4b:	str	r0, [sp, #0xc]
0x00400e4d:	str	r1, [sp, #0x14]
...
0x00401079:	bl	#0x500061

Function LogLuvDecode24 @ 0x004010a5
...
0x004010b3:	cmp	r7, #0
0x004010b5:	beq	#0x401171
0x004010b7:	mov	r6, r1
...
0x0040116d:	bl	#0x500061
0x00401171:	ldr	r3, [pc, #0x38]
0x00401173:	movs	r2, #0xe1
0x00401175:	ldr	r1, [pc, #0x38]
0x00401177:	ldr	r0, [pc, #0x3c]
0x00401179:	add	r3, pc
0x0040117b:	add	r1, pc
0x0040117d:	add.w	r3, r3, #0x588
0x00401181:	add	r0, pc
0x00401183:	bl	#0x500061
0x00401187:	ldr	r3, [pc, #0x30]
...
0x00401199:	bl	#0x500061

Function pix24toXYZ @ 0x004011c5
...
Function Luv24toXYZ @ 0x00401341
...
Function LogLuvEncodeStrip @ 0x00401361
...
0x0040136d:	bl	#0x500019
0x00401371:	mov	r4, r0
0x00401373:	mov	r1, r4
0x00401375:	mov	r0, sl
0x00401377:	bl	#0x500091
0x0040137b:	cbnz	r1, #0x4013b1
0x0040137d:	mov	sb, r1
0x0040137f:	cmp.w	sl, #0
0x00401383:	bne	#0x40138f
0x0040137d:	mov	sb, r1
0x0040137f:	cmp.w	sl, #0
0x00401383:	bne	#0x40138f
0x00401385:	b	#0x4013a7
0x00401387:	add	r6, r4
0x00401389:	subs.w	sl, sl, r4
0x0040138d:	beq	#0x4013a7
0x0040138f:	ldr.w	r5, [r7, #0x19c]
0x00401393:	mov	r3, r8
0x00401395:	mov	r2, r4
0x00401397:	mov	r1, r6
0x00401399:	mov	r0, r7
0x0040139b:	blx	r5
0x0040139d:	cmp	r0, #0
0x0040139f:	beq	#0x401387
0x004013a1:	mov	r0, sb
0x004013a3:	pop.w	{r4, r5, r6, r7, r8, sb, sl, pc}
0x004013a7:	mov.w	sb, #1
0x004013ab:	mov	r0, sb
0x004013ad:	pop.w	{r4, r5, r6, r7, r8, sb, sl, pc}
0x004013b1:	ldr	r3, [pc, #0x14]
...
0x004013c5:	bl	#0x500061

Function LogLuvDecodeStrip @ 0x004013d5
...
0x004013eb:	bl	#0x500091
0x004013ef:	cbnz	r1, #0x40141d
0x004013f1:	cmp.w	sb, #0
0x004013f5:	bne	#0x401401
0x004013f1:	cmp.w	sb, #0
0x004013f5:	bne	#0x401401
0x004013f7:	b	#0x401417
0x004013f9:	add	r6, r4
0x004013fb:	subs.w	sb, sb, r4
0x004013ff:	beq	#0x401417
0x00401401:	ldr.w	r5, [r7, #0x198]
0x00401405:	mov	r3, r8
0x00401407:	mov	r2, r4
0x00401409:	mov	r1, r6
0x0040140b:	mov	r0, r7
0x0040140d:	blx	r5
0x0040140f:	cmp	r0, #0
0x00401411:	bne	#0x4013f9
0x00401413:	pop.w	{r3, r4, r5, r6, r7, r8, sb, pc}
0x00401417:	movs	r0, #1
0x00401419:	pop.w	{r3, r4, r5, r6, r7, r8, sb, pc}
0x0040141d:	ldr	r3, [pc, #0x14]
...
0x00401431:	bl	#0x500061

Function LogLuvEncodeTile @ 0x00401441
...
0x0040144d:	bl	#0x50009d
0x00401451:	mov	r4, r0
0x00401453:	mov	r1, r4
0x00401455:	mov	r0, sl
0x00401457:	bl	#0x500091
0x0040145b:	cbnz	r1, #0x401491
0x0040145d:	mov	sb, r1
0x0040145f:	cmp.w	sl, #0
0x00401463:	bne	#0x40146f
0x0040145d:	mov	sb, r1
0x0040145f:	cmp.w	sl, #0
0x00401463:	bne	#0x40146f
0x00401465:	b	#0x401487
0x00401467:	add	r6, r4
0x00401469:	subs.w	sl, sl, r4
0x0040146d:	beq	#0x401487
0x0040146f:	ldr.w	r5, [r7, #0x19c]
0x00401473:	mov	r3, r8
0x00401475:	mov	r2, r4
0x00401477:	mov	r1, r6
0x00401479:	mov	r0, r7
0x0040147b:	blx	r5
0x0040147d:	cmp	r0, #0
0x0040147f:	beq	#0x401467
0x00401481:	mov	r0, sb
0x00401483:	pop.w	{r4, r5, r6, r7, r8, sb, sl, pc}
0x00401487:	mov.w	sb, #1
0x0040148b:	mov	r0, sb
0x0040148d:	pop.w	{r4, r5, r6, r7, r8, sb, sl, pc}
0x00401491:	ldr	r3, [pc, #0x14]
...
0x004014a5:	bl	#0x500061

Function LogLuvDecodeTile @ 0x004014b5
...
0x004014c1:	bl	#0x50009d
0x004014c5:	mov	r4, r0
0x004014c7:	mov	r1, r4
0x004014c9:	mov	r0, sb
0x004014cb:	bl	#0x500091
0x004014cf:	cbnz	r1, #0x4014fd
0x004014d1:	cmp.w	sb, #0
0x004014d5:	bne	#0x4014e1
0x004014d1:	cmp.w	sb, #0
0x004014d5:	bne	#0x4014e1
0x004014d7:	b	#0x4014f7
0x004014d9:	add	r6, r4
0x004014db:	subs.w	sb, sb, r4
0x004014df:	beq	#0x4014f7
0x004014e1:	ldr.w	r5, [r7, #0x198]
0x004014e5:	mov	r3, r8
0x004014e7:	mov	r2, r4
0x004014e9:	mov	r1, r6
0x004014eb:	mov	r0, r7
0x004014ed:	blx	r5
0x004014ef:	cmp	r0, #0
0x004014f1:	bne	#0x4014d9
0x004014f3:	pop.w	{r3, r4, r5, r6, r7, r8, sb, pc}
0x004014f7:	movs	r0, #1
0x004014f9:	pop.w	{r3, r4, r5, r6, r7, r8, sb, pc}
0x004014fd:	ldr	r3, [pc, #0x14]
...
0x00401511:	bl	#0x500061

Function Luv32fromXYZ @ 0x00401521
...
Function LogLuvInitState @ 0x004016e9
...
0x0040180f:	bl	#0x500061

Function sub_401813 @ 0x00401813
0x00401813:	nop	
0x00401815:	lsrs	r4, r4, #0x1b
0x00401817:	movs	r0, r0
0x00401819:	asrs	r2, r2, #2
0x0040181b:	movs	r0, r0
0x0040181d:	lsrs	r0, r6, #0x19
0x0040181f:	movs	r0, r0
0x00401821:	asrs	r4, r3, #1
0x00401823:	movs	r0, r0
0x00401825:	lsrs	r0, r5, #0x1a
0x00401827:	movs	r0, r0
0x00401829:	asrs	r0, r6, #0x20
0x0040182b:	movs	r0, r0
0x0040182d:	lsrs	r6, r5, #0x12
0x0040182f:	movs	r0, r0
0x00401831:	lsrs	r4, r3, #0x17
0x00401833:	movs	r0, r0
0x00401835:	asrs	r0, r3, #0x20
0x00401837:	movs	r0, r0
0x00401839:	lsrs	r6, r2, #0x12
0x0040183b:	movs	r0, r0
0x0040183d:	lsrs	r4, r3, #0x13
...
Function LogL16InitState @ 0x00401841
0x00401841:	push	{r4, r5, r6, lr}
0x00401843:	ldr.w	r6, [r0, #0x1c4]
0x00401847:	cmp	r6, #0
0x00401849:	beq	#0x40190f
...
0x0040193b:	bl	#0x500061

Function sub_40193f @ 0x0040193f
0x0040193f:	nop	
0x00401941:	lsrs	r2, r2, #0x19
0x00401943:	movs	r0, r0
0x00401945:	lsrs	r0, r0, #0x1e
0x00401947:	movs	r0, r0
0x00401949:	lsrs	r4, r1, #0x17
0x0040194b:	movs	r0, r0
0x0040194d:	lsrs	r4, r0, #0x1c
0x0040194f:	movs	r0, r0
0x00401951:	lsrs	r2, r0, #0xe
0x00401953:	movs	r0, r0
0x00401955:	lsrs	r0, r1, #0xf
0x00401957:	movs	r0, r0
0x00401959:	lsrs	r4, r5, #0x1b
0x0040195b:	movs	r0, r0
0x0040195d:	lsrs	r2, r5, #0xd
0x0040195f:	movs	r0, r0
0x00401961:	lsrs	r0, r4, #0x15
...
Function LogLuvSetupEncode @ 0x00401965
0x00401965:	ldrh.w	r2, [r0, #0x46]
0x00401969:	push	{r3, r4, r5, lr}
0x0040196b:	movw	r3, #0x804c
0x0040196f:	ldr.w	r5, [r0, #0x1c4]
...
0x00401a37:	nop	
0x00401a39:	ldc	p15, c15, [sp], #-0x3fc

Function LogLuvSetupDecode @ 0x00401a6d
...
0x00401b55:	bl	#0x797b57

Function Luv24fromLuv48 @ 0x00401b89
...
Function Luv24toLuv48 @ 0x00401ed9
...
0x00401ff9:	lsrs	r6, r5, #4
0x00401ffb:	movs	r0, r0
0x00401ffd:	lsrs	r6, r3, #4
...
Function Luv32toXYZ @ 0x00402001
0x00402001:	push.w	{r4, r5, r6, r7, r8, lr}
0x00402005:	cmp	r2, #0
0x00402007:	ldr.w	r8, [r0, #8]
0x0040200b:	vpush	{d8, d9, d10, d11, d12, d13}
...
Function Luv24toRGB @ 0x00402131
...
0x004022db:	bl	#0x500079
0x004022df:	vldr	d7, [sp, #8]
0x004022e3:	vldr	d6, [sp]
0x004022e7:	b	#0x40224b
0x004022e9:	vmov.f64	d0, d7
0x004022ed:	bl	#0x500079
0x004022f1:	b	#0x402293
0x004022f3:	vmov.f64	d0, d6
0x004022f7:	vstr	d7, [sp]
0x004022fb:	bl	#0x500079
0x004022ff:	vldr	d7, [sp]
0x00402303:	b	#0x40226f
0x00402305:	bl	#0x5000b5

Function TIFFInitSGILog @ 0x00402365
0x00402365:	sub.w	r1, r1, #0x8700
0x00402369:	push	{r3, r4, r5, lr}
0x0040236b:	subs	r1, #0x74
0x0040236d:	cmp	r1, #1
0x0040236f:	bhi	#0x402415
0x00402371:	mov	r4, r0
0x00402373:	movs	r0, #0x1c
0x00402375:	bl	#0x5000a9
0x00402379:	mov	r5, r0
0x0040237b:	str.w	r0, [r4, #0x1c4]
0x0040237f:	cmp	r0, #0
0x00402381:	beq	#0x4023ff
0x00402383:	ldr	r3, [pc, #0xa8]
...
Function TIFFFlushData1 @ 0x00500055
...
Function _TIFFmemset @ 0x00500085
...
Function __aeabi_idivmod @ 0x00500091
...
Function _TIFFMergeFieldInfo @ 0x005000c1
