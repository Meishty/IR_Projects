...
Function adler32 @ 0x00400359
0x00400359:	b.w	#0x400001

Function adler32_combine @ 0x0040035d
0x0040035d:	cmp	r2, #0
0x0040035f:	blt	#0x4003db
0x00400361:	push	{r4, lr}
0x00400363:	movw	r4, #0x8071
0x00400367:	movt	r4, #0x8007
0x0040036b:	movw	lr, #0xfff1
0x0040036f:	umull	r3, ip, r4, r2
0x00400373:	lsr.w	ip, ip, #0xf
0x00400377:	mls	ip, lr, ip, r2
0x0040037b:	uxth	r2, r0
0x0040037d:	rsb	r3, ip, r0, lsr #16
0x00400381:	movw	r0, #0xfff0
0x00400385:	mul	ip, r2, ip
0x00400389:	add.w	r3, r3, r1, lsr #16
0x0040038d:	uxtah	r1, r2, r1
0x00400391:	umull	r2, r4, r4, ip
0x00400395:	lsrs	r4, r4, #0xf
0x00400397:	mls	ip, lr, r4, ip
0x0040039b:	add	r3, ip
0x0040039d:	add.w	r2, r3, lr
0x004003a1:	cbz	r1, #0x4003b3
0x004003a3:	subs	r0, r1, #1
0x004003a5:	movw	r4, #0xfff0
0x004003a9:	cmp	r0, r4
0x004003ab:	itt	hi
0x004003ad:	subhi.w	r0, r1, #0xff00
0x004003b1:	subhi	r0, #0xf2
0x004003b3:	movw	r1, #0xffe1
0x004003b7:	movt	r1, #1
0x004003bb:	cmp	r2, r1
0x004003bd:	it	hi
0x004003bf:	subhi.w	r2, r3, #0xff00
0x004003c3:	movw	r3, #0xfff0
0x004003c7:	it	hi
0x004003c9:	subhi	r2, #0xf1
0x004003cb:	cmp	r2, r3
0x004003cd:	itt	hi
0x004003cf:	subhi.w	r2, r2, #0xff00
0x004003d3:	subhi	r2, #0xf1
0x004003d5:	orr.w	r0, r0, r2, lsl #16
...
0x004003d5:	orr.w	r0, r0, r2, lsl #16
0x004003d9:	pop	{r4, pc}
0x004003db:	mov.w	r0, #-1
0x004003df:	bx	lr

Function adler32_combine64 @ 0x004003e1
0x004003e1:	cmp	r2, #0
0x004003e3:	blt	#0x40045f
0x004003e5:	push	{r4, lr}
0x004003e7:	movw	r4, #0x8071
0x004003eb:	movt	r4, #0x8007
0x004003ef:	movw	lr, #0xfff1
0x004003f3:	umull	r3, ip, r4, r2
0x004003f7:	lsr.w	ip, ip, #0xf
0x004003fb:	mls	ip, lr, ip, r2
0x004003ff:	uxth	r2, r0
0x00400401:	rsb	r3, ip, r0, lsr #16
0x00400405:	movw	r0, #0xfff0
0x00400409:	mul	ip, r2, ip
0x0040040d:	add.w	r3, r3, r1, lsr #16
0x00400411:	uxtah	r1, r2, r1
0x00400415:	umull	r2, r4, r4, ip
0x00400419:	lsrs	r4, r4, #0xf
0x0040041b:	mls	ip, lr, r4, ip
0x0040041f:	add	r3, ip
0x00400421:	add.w	r2, r3, lr
0x00400425:	cbz	r1, #0x400437
0x00400427:	subs	r0, r1, #1
0x00400429:	movw	r4, #0xfff0
0x0040042d:	cmp	r0, r4
0x0040042f:	itt	hi
0x00400431:	subhi.w	r0, r1, #0xff00
0x00400435:	subhi	r0, #0xf2
0x00400437:	movw	r1, #0xffe1
0x0040043b:	movt	r1, #1
0x0040043f:	cmp	r2, r1
0x00400441:	it	hi
0x00400443:	subhi.w	r2, r3, #0xff00
0x00400447:	movw	r3, #0xfff0
0x0040044b:	it	hi
0x0040044d:	subhi	r2, #0xf1
0x0040044f:	cmp	r2, r3
0x00400451:	itt	hi
0x00400453:	subhi.w	r2, r2, #0xff00
0x00400457:	subhi	r2, #0xf1
0x00400459:	orr.w	r0, r0, r2, lsl #16
0x0040045d:	pop	{r4, pc}
0x00400427:	subs	r0, r1, #1
0x00400429:	movw	r4, #0xfff0
0x0040042d:	cmp	r0, r4
0x0040042f:	itt	hi
