...
Function usage.constprop.0 @ 0x00400291
0x00400291:	ldr	r0, [pc, #0x50]
0x00400293:	push	{lr}
0x00400295:	ldr	r1, [pc, #0x50]
0x00400297:	add	r0, pc
0x00400299:	sub.w	sp, sp, #0x2000
0x0040029d:	sub	sp, #0xc
0x0040029f:	ldr	r3, [pc, #0x4c]
0x004002a1:	add.w	r4, sp, #0x2000
0x004002a5:	ldr	r2, [pc, #0x48]
0x004002a7:	ldr	r1, [r0, r1]
0x004002a9:	add	r3, pc
0x004002ab:	adds	r4, #4
0x004002ad:	ldr	r1, [r1]
0x004002af:	str	r1, [r4]
0x004002b1:	mov.w	r1, #0
0x004002b5:	ldr	r4, [pc, #0x3c]
0x004002b7:	add	r1, sp, #4
0x004002b9:	add	r4, pc
0x004002bb:	ldr	r5, [r3, r2]
0x004002bd:	ldr	r0, [r5]
0x004002bf:	bl	#0x500019
0x004002c3:	ldr	r3, [r4]
0x004002c5:	cbz	r3, #0x4002dd
0x004002c7:	ldr	r6, [pc, #0x30]
0x004002c9:	add	r6, pc
0x004002cb:	ldr	r0, [r5]
0x004002cd:	mov	r2, r6
...
0x004002cf:	movs	r1, #1
0x004002d1:	bl	#0x500025
0x004002d5:	ldr	r3, [r4, #4]!
0x004002d9:	cmp	r3, #0
0x004002db:	bne	#0x4002cb
0x004002dd:	mov.w	r0, #-1
0x004002e1:	bl	#0x500031

Function printTIF @ 0x004002fd
...
0x00400605:	lsls	r4, r2, #0x16
0x00400607:	movs	r0, r0
0x00400609:	lsls	r0, r4, #0x16
0x0040060b:	movs	r0, r0
0x0040060d:	lsls	r4, r3, #0x13
0x0040060f:	movs	r0, r0
0x00400611:	lsls	r0, r4, #0x12
0x00400613:	movs	r0, r0
0x00400615:	lsls	r6, r5, #0x15
0x00400617:	movs	r0, r0
0x00400619:	lsls	r0, r3, #0x14
0x0040061b:	movs	r0, r0
0x0040061d:	lsls	r6, r1, #0x14
0x0040061f:	movs	r0, r0

Function fax2ps.part.0 @ 0x00400655
...
0x0040076d:	bl	#0x500091

Function findPage @ 0x0040078d
...
0x00400815:	bl	#0x5000a9
0x00400819:	b	#0x4007f1
0x0040081b:	bl	#0x500091
...
0x004017a3:	bl	#0x5000fd
0x004017a7:	mov	r0, r5
0x004017a9:	bl	#0x500175
0x004017ad:	b	#0x401609
0x004017af:	mov	r0, r3
0x004017b1:	bl	#0x500181
...
0x004017c5:	bl	#0x500025
0x004017c9:	b	#0x4017a7
0x004017cb:	bl	#0x400291
...
0x004017df:	bl	#0x500025
0x004017e3:	bl	#0x400291
0x004017e7:	bl	#0x500091
...
0x004017f9:	bl	#0x500025
0x004017fd:	mvn	r0, #1
0x00401801:	bl	#0x500031
...
Function TIFFNumberOfStrips @ 0x00500061
...
Function TIFFReadEncodedStrip @ 0x0050006d
...
Function TIFFFileName @ 0x00500079
...
Function TIFFWarning @ 0x00500085
...
Function TIFFReadDirectory @ 0x0050009d
...
Function TIFFSetDirectory @ 0x005000a9
...
Function TIFFSetWarningHandler @ 0x00500181
