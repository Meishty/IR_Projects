...
Function ideaExpandKey @ 0x00400001
...
Function ideaCipher @ 0x00400095
...
Function ideaCfbReinit @ 0x00400289
...
Function ideaCfbInit @ 0x004002ad
0x004002ad:	push	{r4, lr}
0x004002af:	mov	r4, r0
0x004002b1:	mov	r0, r1
0x004002b3:	add.w	r1, r4, #0x10
...
Function ideaCfbDestroy @ 0x004002c5
0x004002c5:	movs	r2, #0x7c
0x004002c7:	movs	r1, #0
0x004002c9:	b.w	#0x500031

Function ideaCfbSync @ 0x004002cd
...
Function ideaCfbEncrypt @ 0x004002f9
...
Function ideaCfbDecrypt @ 0x004006f5
...
Function ideaRandInit @ 0x00400bd1
...
Function ideaRandState @ 0x00400bf1
0x00400bf1:	ldr	r3, [r0, #0x74]
0x00400bf3:	ldr.w	ip, [r0, #0x78]
0x00400bf7:	str.w	ip, [r2, #4]
0x00400bfb:	str	r3, [r2]
...
Function ideaRandWash @ 0x00400c51
0x00400c51:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400c55:	mov	r4, r1
0x00400c57:	ldr	r2, [pc, #0x378]
0x00400c59:	sub	sp, #0x34
...
Function ideaRandByte @ 0x00400fdd
0x00400fdd:	ldr	r2, [pc, #0x7c]
0x00400fdf:	ldr	r3, [pc, #0x80]
0x00400fe1:	add	r2, pc
0x00400fe3:	push	{r4, r5, r6, lr}
...
Function randPoolGetBytes @ 0x00500025
