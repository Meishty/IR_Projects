...
Function encrypt_body @ 0x004003c9
...
Function input @ 0x0040070d
0x0040070d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400711:	mov	r8, r1
0x00400713:	ldr	r1, [pc, #0x2c8]
0x00400715:	mov	r7, r2
0x00400717:	ldr	r2, [pc, #0x2c8]
0x00400719:	add	r1, pc
0x0040071b:	sub	sp, #0x54
0x0040071d:	ldr	r2, [r1, r2]
0x0040071f:	ldr	r2, [r2]
0x00400721:	str	r2, [sp, #0x4c]
0x00400723:	mov.w	r2, #0
0x00400727:	clz	r2, r3
0x0040072b:	lsrs	r2, r2, #5
0x0040072d:	cmp	r7, #0
0x0040072f:	it	ne
0x00400731:	orrne	r2, r2, #1
0x00400735:	cmp	r2, #0
0x00400737:	beq.w	#0x4009cb
0x0040073b:	cmp	r3, #0x2f
0x0040073d:	mov	r4, r0
0x0040073f:	mov	r6, r3
0x00400741:	it	hi
0x00400743:	strhi.w	r8, [sp, #0x14]
0x00400747:	bhi	#0x4007c5
0x00400749:	b	#0x400989
0x0040074b:	str	r0, [r4]
0x0040074d:	mov	r0, r4
0x0040074f:	ldr.w	r5, [ip, #4]
0x00400753:	eors	r5, r2
0x00400755:	str	r5, [r4, #4]
0x00400757:	ldr	r5, [sp, #4]
0x00400759:	ldr.w	r2, [ip, #8]
...
0x004007c7:	mov	r5, r6
0x004007c9:	ldr	r0, [r7]
0x004007cb:	mov	ip, r7
0x004007cd:	ldr	r3, [r4, #0x3c]
0x004007cf:	adds	r7, #0x30
0x004007d1:	eors	r0, r1
0x004007d3:	ldr	r1, [sp, #0x14]
0x004007d5:	ldr	r6, [r4, #0x14]
0x004007d7:	cmp	r5, #0x30
0x004007d9:	eor.w	fp, r1, r3
0x004007dd:	ldr	r3, [r4, #0x18]
0x004007df:	str	r3, [sp, #8]
0x004007e1:	ldr	r3, [r4, #0x1c]
0x004007e3:	str	r3, [sp, #0xc]
0x004007e5:	ldr	r3, [r4, #0x20]
0x004007e7:	str	r6, [sp, #4]
0x004007e9:	sub.w	r6, r5, #0x30
0x004007ed:	str	r3, [sp, #0x10]
0x004007ef:	ldrd	r2, sb, [r4, #4]
0x004007f3:	ldrd	lr, r8, [r4, #0xc]
0x004007f7:	ldrd	r3, r1, [r4, #0x24]
0x004007fb:	ldr.w	sl, [r4, #0x2c]
0x004007ff:	bne	#0x40074b
0x00400801:	str	r0, [r4]
...
0x00400985:	bl	#0x500025
0x00400989:	mov.w	r8, #0
0x0040098d:	add.w	sb, sp, #0x18
0x00400991:	rsb.w	r5, r8, #0x30
0x00400995:	add.w	r0, sb, r8
0x00400999:	cmp	r6, #0
0x0040099b:	beq.w	#0x400883
0x00400991:	rsb.w	r5, r8, #0x30
0x00400995:	add.w	r0, sb, r8
0x00400999:	cmp	r6, #0
0x0040099b:	beq.w	#0x400883
0x0040099f:	cmp	r5, r6
0x004009a1:	mov	r1, r7
0x004009a3:	it	hs
0x004009a5:	movhs	r5, r6
0x004009a7:	mov	r2, r5
0x004009a9:	add	r8, r5
0x004009ab:	bl	#0x500019
0x004009af:	add	r7, r5
0x004009b1:	subs	r6, r6, r5
0x004009b3:	cmp.w	r8, #0x2f
0x004009b7:	bls	#0x400991
0x004009b9:	ldr	r3, [pc, #0x2c]
0x004009bb:	movs	r2, #0x8a
0x004009bd:	ldr	r1, [pc, #0x2c]
0x004009bf:	ldr	r0, [pc, #0x30]
0x004009c1:	add	r3, pc
0x004009c3:	add	r1, pc
0x004009c5:	add	r0, pc
0x004009c7:	bl	#0x500031
0x004009cb:	ldr	r3, [pc, #0x28]
...
0x004009d9:	bl	#0x500031

Function sub_4007bf @ 0x004007bf
0x004007bf:	cmp	r6, #0x2f
0x004007c1:	bls.w	#0x400989
...
Function input_block @ 0x00400a01
0x00400a01:	ldr	r3, [r0]
0x00400a03:	mvns	r2, r1
0x00400a05:	push	{r4, r5}
0x00400a07:	orr.w	ip, r1, r3
...
Function cf_blockwise_accumulate_final @ 0x00400b0d
0x00400b0d:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x00400b11:	sub	sp, #0xc
0x00400b13:	ldrd	r5, sl, [sp, #0x30]
0x00400b17:	ldrd	fp, r4, [sp, #0x38]
...
0x00400c43:	nop	
0x00400c45:	lsrs	r6, r3, #0x20
0x00400c47:	movs	r0, r0
0x00400c49:	lsls	r0, r0, #0x1a
0x00400c4b:	movs	r0, r0
0x00400c4d:	lsls	r2, r7, #0x1a
0x00400c4f:	movs	r0, r0
0x00400c51:	lsls	r2, r7, #0x1f
0x00400c53:	movs	r0, r0
0x00400c55:	lsls	r4, r3, #0x19
0x00400c57:	movs	r0, r0
0x00400c59:	lsls	r2, r3, #0x1b
0x00400c5b:	movs	r0, r0
0x00400c5d:	lsls	r0, r5, #0x1f
0x00400c5f:	movs	r0, r0
0x00400c61:	lsls	r2, r1, #0x19
0x00400c63:	movs	r0, r0
0x00400c65:	lsls	r4, r6, #0x19
0x00400c67:	movs	r0, r0
0x00400c69:	lsls	r6, r2, #0x1f
0x00400c6b:	movs	r0, r0
0x00400c6d:	lsls	r0, r7, #0x18
0x00400c6f:	movs	r0, r0
0x00400c71:	lsls	r6, r0, #0x1a
0x00400c73:	movs	r0, r0
0x00400c75:	lsls	r4, r0, #0x1f
0x00400c77:	movs	r0, r0
0x00400c79:	lsls	r6, r4, #0x18
0x00400c7b:	movs	r0, r0
0x00400c7d:	lsls	r4, r2, #0x1a
...
0x00400c93:	bl	#0x400b0d

Function cf_blockwise_accumulate @ 0x00400c81
0x00400c81:	push	{r4, lr}
0x00400c83:	sub	sp, #0x10
0x00400c85:	ldr	r4, [sp, #0x18]
0x00400c87:	str	r4, [sp]
...
Function cf_norx32_encrypt @ 0x00400c9d
0x00400c9d:	push.w	{r4, r5, r6, r7, r8, sb, sl, lr}
0x00400ca1:	mov	r6, r2
0x00400ca3:	ldr	r2, [pc, #0x13c]
0x00400ca5:	mov	r5, r3
...
Function cf_norx32_decrypt @ 0x00400ded
...
0x00401225:	bl	#0x500001
0x00401229:	movs	r0, #1
0x0040122b:	b	#0x4011e9
0x00401255:	bl	#0x500025
