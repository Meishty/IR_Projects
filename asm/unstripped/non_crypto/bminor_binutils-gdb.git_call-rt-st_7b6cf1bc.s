...
Function init_bit_flags_char @ 0x00400005
0x00400005:	and	r2, r2, #1
0x00400009:	push	{r4}
...
Function init_bit_flags_short @ 0x00400049
...
Function init_bit_flags @ 0x0040008d
...
Function init_bit_flags_combo @ 0x004000d1
...
Function init_one_double @ 0x0040012d
0x0040012d:	vstr	d0, [r0]
0x00400131:	bx	lr
...
Function init_two_floats @ 0x00400135
0x00400135:	vstr	s0, [r0]
0x00400139:	vstr	s1, [r0, #4]
0x0040013d:	bx	lr
...
Function init_three_chars @ 0x00400141
0x00400141:	strb	r1, [r0]
0x00400143:	strb	r2, [r0, #1]
0x00400145:	strb	r3, [r0, #2]
0x00400147:	bx	lr

Function init_five_chars @ 0x00400149
...
Function init_int_char_combo @ 0x00400171
...
Function init_struct_rep @ 0x00400179
0x00400179:	adds	r1, #1
0x0040017b:	movs	r3, #0
0x0040017d:	lsls	r1, r1, #1
0x0040017f:	strd	r1, r3, [r0]
...
Function print_bit_flags_char @ 0x00400185
...
0x004001ef:	nop	
0x004001f1:	lsls	r0, r2, #0x11
0x004001f3:	movs	r0, r0
0x004001f5:	lsls	r4, r1, #0x11
0x004001f7:	movs	r0, r0
0x004001f9:	lsls	r0, r1, #0x11
0x004001fb:	movs	r0, r0
0x004001fd:	lsls	r4, r0, #0x11
0x004001ff:	movs	r0, r0
0x00400201:	lsls	r0, r0, #0x11
0x00400203:	movs	r0, r0
0x00400205:	lsls	r4, r7, #0x10
...
Function print_bit_flags_short @ 0x00400209
0x00400209:	push	{r3, r4, r5, lr}
0x0040020b:	mov	r4, r0
0x0040020d:	uxtb	r5, r0
0x0040020f:	lsls	r2, r4, #0x1f
...
0x00400273:	nop	
0x00400275:	lsls	r4, r1, #0xf
0x00400277:	movs	r0, r0
0x00400279:	lsls	r0, r1, #0xf
0x0040027b:	movs	r0, r0
0x0040027d:	lsls	r4, r0, #0xf
0x0040027f:	movs	r0, r0
0x00400281:	lsls	r0, r0, #0xf
0x00400283:	movs	r0, r0
0x00400285:	lsls	r4, r7, #0xe
0x00400287:	movs	r0, r0
0x00400289:	lsls	r0, r7, #0xe
...
Function print_bit_flags @ 0x0040028d
0x0040028d:	push	{r3, r4, r5, lr}
0x0040028f:	lsls	r2, r0, #0x1f
0x00400291:	mov	r4, r0
0x00400293:	uxtb	r5, r0
...
0x004002f7:	nop	
0x004002f9:	lsls	r0, r1, #0xd
0x004002fb:	movs	r0, r0
0x004002fd:	lsls	r4, r0, #0xd
0x004002ff:	movs	r0, r0
0x00400301:	lsls	r0, r0, #0xd
0x00400303:	movs	r0, r0
0x00400305:	lsls	r4, r7, #0xc
0x00400307:	movs	r0, r0
0x00400309:	lsls	r0, r7, #0xc
0x0040030b:	movs	r0, r0
0x0040030d:	lsls	r4, r6, #0xc
...
Function print_bit_flags_combo @ 0x00400311
0x00400311:	push	{r4, r5, r6, lr}
0x00400313:	mov	r4, r0
0x00400315:	sub	sp, #8
0x00400317:	mov	r5, sp
...
0x004003af:	nop	
0x004003b1:	lsls	r4, r3, #0xb
0x004003b3:	movs	r0, r0
0x004003b5:	lsls	r6, r2, #0xa
0x004003b7:	movs	r0, r0
0x004003b9:	lsls	r2, r2, #0xa
0x004003bb:	movs	r0, r0
0x004003bd:	lsls	r2, r1, #0xa
0x004003bf:	movs	r0, r0
0x004003c1:	lsls	r6, r0, #0xa
0x004003c3:	movs	r0, r0
0x004003c5:	lsls	r6, r7, #9
0x004003c7:	movs	r0, r0
0x004003c9:	lsls	r2, r7, #9
...
Function print_one_double @ 0x004003cd
0x004003cd:	push	{r3, lr}
0x004003cf:	ldr	r0, [pc, #0x28]
0x004003d1:	vpush	{d8}
0x004003d5:	vmov.f64	d8, d0
...
0x004003f7:	nop	
0x004003f9:	lsls	r4, r4, #9
0x004003fb:	movs	r0, r0
0x004003fd:	lsls	r2, r6, #9
...
Function print_two_floats @ 0x00400401
0x00400401:	push	{lr}
0x00400403:	ldr	r0, [pc, #0x40]
0x00400405:	vpush	{d8}
0x00400409:	vmov.f32	s17, s0
...
Function print_three_chars @ 0x0040044d
...
0x0040048b:	nop	
0x0040048d:	lsls	r6, r4, #8
0x0040048f:	movs	r0, r0
0x00400491:	lsls	r4, r6, #8
...
Function print_five_chars @ 0x00400495
0x00400495:	push	{r4, r5, lr}
0x00400497:	mov	r4, r0
0x00400499:	ldr	r0, [pc, #0x40]
0x0040049b:	sub	sp, #0x1c
...
0x004004db:	nop	
0x004004dd:	lsls	r2, r1, #8
0x004004df:	movs	r0, r0
0x004004e1:	lsls	r2, r1, #8
...
0x004004f5:	bl	#0x500001

Function print_int_char_combo @ 0x004004e5
0x004004e5:	push	{r4, r5, lr}
0x004004e7:	mov	r5, r0
0x004004e9:	ldr	r0, [pc, #0x2c]
0x004004eb:	sub	sp, #0xc
...
0x00400517:	nop	
0x00400519:	lsls	r6, r4, #7
0x0040051b:	movs	r0, r0
0x0040051d:	lsls	r2, r6, #7
...
Function print_struct_rep @ 0x00400521
0x00400521:	push	{r4, r5, lr}
0x00400523:	mov	r5, r0
0x00400525:	ldr	r0, [pc, #0x30]
0x00400527:	sub	sp, #0x14
...
0x00400557:	nop	
0x00400559:	lsls	r2, r2, #7
0x0040055b:	movs	r0, r0
0x0040055d:	lsls	r6, r2, #7
...
Function print_one_large_struct @ 0x00400561
0x00400561:	sub	sp, #0x10
0x00400563:	push	{r3, r4, r5, lr}
0x00400565:	mov	r4, r0
0x00400567:	movs	r0, #1
...
Function init_array_rep @ 0x00400595
0x00400595:	push	{r4}
0x00400597:	movs	r4, #1
0x00400599:	movs	r3, #2
0x0040059b:	lsls	r1, r4
...
0x00400749:	bl	#0x500025
0x0040074d:	bl	#0x500031
0x00400751:	cmp	r0, #0
