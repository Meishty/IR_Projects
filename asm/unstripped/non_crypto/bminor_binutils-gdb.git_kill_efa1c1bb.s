...
0x00400016:	ldmib	r4, {r2, r4, r5, r6, r7, r8, sb, sl, fp, ip, sp, lr, pc} ^
...
Function rl_vi_yank_pop @ 0x0040003d
0x0040003d:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400041:	ldr	r4, [pc, #0x94]
0x00400043:	ldr	r1, [pc, #0x98]
0x00400045:	add	r4, pc
...
Function rl_yank_nth_arg_internal @ 0x004000f9
...
0x00400255:	bl	#0x5000cd
0x00400259:	ldr	r1, [sp, #4]
0x0040025b:	b	#0x400229

Function _rl_copy_to_kill_ring.isra.0 @ 0x00400289
...
0x00400367:	bl	#0x5000e5
0x0040036b:	mov	r1, r7
0x0040036d:	bl	#0x5000f1
...
Function rl_yank_pop @ 0x00400391
0x00400391:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400395:	ldr	r4, [pc, #0xac]
0x00400397:	ldr	r1, [pc, #0xb0]
0x00400399:	add	r4, pc
...
0x00400433:	bl	#0x500019
0x00400437:	movs	r0, #1
0x00400439:	pop.w	{r4, r5, r6, r7, r8, pc}
0x00400439:	pop.w	{r4, r5, r6, r7, r8, pc}
0x0040043d:	bl	#0x500019
0x00400441:	mov	r0, r4
0x00400443:	b	#0x400439

Function rl_set_retained_kills @ 0x00400469
0x00400469:	movs	r0, #0
0x0040046b:	bx	lr

Function rl_kill_text @ 0x0040046d
...
Function rl_kill_word @ 0x004004ad
...
Function rl_backward_kill_word @ 0x00400575
0x00400575:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400579:	subs	r3, r0, #0
0x0040057b:	ldr	r4, [pc, #0x70]
0x0040057d:	add	r4, pc
...
0x004005e9:	b.w	#0x4004ad

Function rl_kill_line @ 0x00400601
...
Function rl_backward_kill_line @ 0x004006d5
0x004006d5:	push.w	{r4, r5, r6, r7, r8, lr}
0x004006d9:	cmp	r0, #0
0x004006db:	ldr	r4, [pc, #0xb0]
0x004006dd:	ldr	r3, [pc, #0xb0]
...
0x004007a7:	bl	#0x50009d

Function rl_kill_full_line @ 0x004007a1
0x004007a1:	push	{r3, r4, r5, r6, r7, lr}
0x004007a3:	movs	r6, #0
0x004007a5:	ldr	r4, [pc, #0x4c]
0x004007a7:	bl	#0x50009d
...
0x004007ed:	bl	#0x5000b5
0x004007f1:	mov	r0, r5
0x004007f3:	pop	{r3, r4, r5, r6, r7, pc}

Function rl_unix_word_rubout @ 0x00400809
...
Function rl_unix_filename_rubout @ 0x004008d1
...
0x00400a77:	bl	#0x500085

Function rl_unix_line_discard @ 0x00400a69
0x00400a69:	push	{r3, r4, r5, r6, r7, lr}
0x00400a6b:	ldr	r4, [pc, #0x50]
0x00400a6d:	ldr	r3, [pc, #0x50]
0x00400a6f:	add	r4, pc
...
Function rl_copy_region_to_kill @ 0x00400ad1
0x00400ad1:	push	{r4, r5, r6, lr}
0x00400ad3:	ldr	r4, [pc, #0x3c]
0x00400ad5:	ldr	r2, [pc, #0x3c]
0x00400ad7:	ldr	r3, [pc, #0x40]
...
Function rl_kill_region @ 0x00400b21
0x00400b21:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400b25:	ldr	r4, [pc, #0x58]
0x00400b27:	ldr	r2, [pc, #0x5c]
0x00400b29:	ldr	r3, [pc, #0x5c]
...
Function rl_copy_backward_word @ 0x00400b91
0x00400b91:	push.w	{r3, r4, r5, r6, r7, r8, sb, lr}
0x00400b95:	subs	r4, r0, #0
0x00400b97:	ldr	r5, [pc, #0x6c]
0x00400b99:	add	r5, pc
...
0x00400c01:	b.w	#0x400c15

Function rl_copy_forward_word @ 0x00400c15
...
0x00400cfd:	bl	#0x50000d
0x00400d01:	mov	r0, r4
0x00400d03:	bl	#0x5000a9
0x00400d07:	bl	#0x5000b5
...
0x00400d1b:	bl	#0x5000c1
0x00400d1f:	ldr	r0, [pc, #0x1c]
0x00400d21:	add	r0, pc
0x00400d23:	bl	#0x50000d
0x00400d27:	b	#0x400cfb

Function _rl_bracketed_text @ 0x00400d41
...
Function rl_bracketed_paste_begin @ 0x00400e45
...
0x00400ea5:	bl	#0x500175
0x00400ea9:	b	#0x400e85
0x00400eab:	bl	#0x500181
...
Function _rl_read_bracketed_paste_prefix @ 0x00400ecd
0x00400ecd:	ldr	r1, [pc, #0xa0]
0x00400ecf:	cmp	r0, #0x1b
0x00400ed1:	ldr	r2, [pc, #0xa0]
0x00400ed3:	it	ne
...
0x00400f09:	tst.w	r3, #0x20800
0x00400f0d:	bne	#0x400f57
0x00400f0f:	bl	#0x50018d
0x00400f13:	cbnz	r0, #0x400f57
0x00400f15:	bl	#0x500199
0x00400f15:	bl	#0x500199
0x00400f19:	cbz	r0, #0x400f57
0x00400f1b:	bl	#0x50015d
0x00400f1b:	bl	#0x50015d
...
0x00400f6d:	bl	#0x500181

Function _rl_bracketed_read_key @ 0x00400f89
...
0x00401035:	bl	#0x500181

Function _rl_bracketed_read_mbstring @ 0x00401051
...
0x00401117:	bl	#0x5000a9
0x0040111b:	mov	r4, r5
0x0040111d:	b	#0x4010a7
0x0040111f:	bl	#0x500181
...
Function _rl_set_mark_at_pos @ 0x00500001
...
Function rl_insert_text @ 0x0050000d
...
Function _rl_abort_internal @ 0x00500019
...
Function rl_delete_text @ 0x0050003d
...
Function where_history @ 0x00500055
...
Function previous_history @ 0x00500061
...
Function history_set_pos @ 0x0050006d
...
Function history_arg_extract @ 0x00500079
...
Function rl_begin_undo_group @ 0x0050009d
...
Function rl_end_undo_group @ 0x005000b5
...
Function rl_vi_append_mode @ 0x005000c1
...
Function rl_do_undo @ 0x005000cd
...
Function rl_copy_text @ 0x00500115
...
Function rl_forward_word @ 0x00500121
...
Function rl_backward_word @ 0x0050012d
...
Function rl_end_of_line @ 0x00500139
...
Function _rl_fix_point @ 0x00500151
...
Function rl_read_key @ 0x0050015d
...
Function _rl_add_macro_char @ 0x00500169
...
Function rl_activate_mark @ 0x00500175
...
Function __stack_chk_fail @ 0x00500181
...
Function _rl_pushed_input_available @ 0x0050018d
...
Function _rl_input_queued @ 0x00500199
...
Function _rl_unget_char @ 0x005001a5
