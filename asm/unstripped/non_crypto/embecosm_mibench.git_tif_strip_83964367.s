...
Function TIFFComputeStrip @ 0x00400001
...
Function TIFFNumberOfStrips @ 0x00400041
0x00400041:	ldr	r3, [r0, #0x28]
0x00400043:	ldr	r1, [r0, #0x50]
0x00400045:	push	{r4, lr}
0x00400047:	mov	r4, r0
...
Function TIFFVStripSize @ 0x0040006d
0x0040006d:	push	{r3, r4, r5, r6, r7, lr}
0x0040006f:	adds	r4, r1, #1
0x00400071:	ldrh.w	r2, [r0, #0x72]
0x00400075:	it	ne
...
Function TIFFStripSize @ 0x004000f1
...
Function TIFFDefaultStripSize @ 0x0040017d
...
Function _TIFFDefaultStripSize @ 0x00400185
0x00400185:	push	{r3, lr}
0x00400187:	mov	r3, r0
0x00400189:	subs	r0, r1, #0
0x0040018b:	ble	#0x40018f
...
Function TIFFScanlineSize @ 0x004001c9
...
Function TIFFRasterScanlineSize @ 0x004001e9
0x004001e9:	push	{r4}
