...
0x004007b5:	movs	r0, #0x60
0x004007b7:	movs	r0, r0
0x004007b9:	subs	r0, r7, #5
0x004007bb:	movs	r0, r0
0x004007bd:	adds	r0, r0, #5
0x004007bf:	movs	r0, r0
0x004007c1:	adds	r6, r6, #3
0x004007c3:	movs	r0, r0
0x004007c5:	adds	r6, r0, #3
0x004007c7:	movs	r0, r0
0x004007c9:	adds	r0, r3, #2
0x004007cb:	movs	r0, r0
0x004007cd:	adds	r2, r5, #1
0x004007cf:	movs	r0, r0
0x004007d1:	adds	r2, r7, #0
0x004007d3:	movs	r0, r0
0x004007d5:	adds	r4, r1, #0
0x004007d7:	movs	r0, r0
0x004007d9:	subs	r4, r3, r7
0x004007db:	movs	r0, r0
0x004007dd:	subs	r6, r5, r6
0x004007df:	movs	r0, r0
0x004007e1:	subs	r6, r7, r5
0x004007e3:	movs	r0, r0
0x004007e5:	subs	r0, r2, r5
0x004007e7:	movs	r0, r0
0x004007e9:	subs	r6, r3, r4
0x004007eb:	movs	r0, r0
0x004007ed:	subs	r2, r5, r3
0x004007ef:	movs	r0, r0
0x004007f1:	subs	r4, r2, r2
0x004007f3:	movs	r0, r0
0x004007f5:	adds	r0, r1, r6
0x004007f7:	movs	r0, r0
0x004007f9:	adds	r2, r3, r5
0x004007fb:	movs	r0, r0
0x004007fd:	adds	r0, r6, r4
0x004007ff:	movs	r0, r0
0x00400801:	adds	r2, r5, r4
0x00400803:	movs	r0, r0
0x00400805:	adds	r4, r4, r4
0x00400807:	movs	r0, r0
0x00400809:	adds	r6, r3, r4
0x0040080b:	movs	r0, r0
0x0040080d:	adds	r0, r3, r4
0x0040080f:	movs	r0, r0
0x00400811:	adds	r2, r2, r4
0x00400813:	movs	r0, r0
0x00400815:	adds	r4, r1, r4
0x00400817:	movs	r0, r0
0x00400819:	adds	r6, r0, r4
...
0x004011eb:	nop	
0x004011ed:	asrs	r4, r5, #0x13
0x004011ef:	movs	r0, r0
0x004011f1:	asrs	r4, r7, #0xc
0x004011f3:	movs	r0, r0
0x004011f5:	asrs	r6, r5, #0xb
0x004011f7:	movs	r0, r0
0x004011f9:	asrs	r6, r3, #0xa
0x004011fb:	movs	r0, r0
0x004011fd:	asrs	r0, r4, #9
0x004011ff:	movs	r0, r0
0x00401201:	asrs	r4, r4, #2
0x00401203:	movs	r0, r0
0x00401205:	asrs	r0, r0, #2
0x00401207:	movs	r0, r0
0x00401209:	asrs	r6, r3, #0x20
0x0040120b:	movs	r0, r0
0x0040120d:	lsrs	r0, r6, #0x1f
0x0040120f:	movs	r0, r0
0x00401211:	lsrs	r2, r0, #0x1f
0x00401213:	movs	r0, r0
0x00401215:	lsrs	r2, r4, #0x1e
0x00401217:	movs	r0, r0
0x00401219:	lsrs	r4, r0, #0x1d
0x0040121b:	movs	r0, r0
0x0040121d:	lsrs	r2, r1, #0x1c
...
0x00401ddf:	nop	
0x00401de1:	lsrs	r4, r1, #0x19
0x00401de3:	movs	r0, r0
0x00401de5:	lsrs	r6, r0, #0x18
0x00401de7:	movs	r0, r0
0x00401de9:	lsrs	r2, r4, #0x16
0x00401deb:	movs	r0, r0
0x00401ded:	lsrs	r6, r7, #0x14
0x00401def:	movs	r0, r0
0x00401df1:	lsrs	r2, r3, #0x13
0x00401df3:	movs	r0, r0
0x00401df5:	lsrs	r6, r6, #0x11
0x00401df7:	movs	r0, r0
0x00401df9:	lsrs	r2, r2, #0x10
0x00401dfb:	movs	r0, r0
0x00401dfd:	lsrs	r4, r5, #0xe
0x00401dff:	movs	r0, r0
0x00401e01:	lsrs	r6, r1, #0xb
0x00401e03:	movs	r0, r0
0x00401e05:	lsrs	r2, r6, #0xa
0x00401e07:	movs	r0, r0
0x00401e09:	lsrs	r2, r7, #9
0x00401e0b:	movs	r0, r0
0x00401e0d:	lsrs	r4, r0, #9
0x00401e0f:	movs	r0, r0
0x00401e11:	lsrs	r6, r1, #8
0x00401e13:	movs	r0, r0
0x00401e15:	lsrs	r0, r3, #7
0x00401e17:	movs	r0, r0
0x00401e19:	lsrs	r2, r4, #6
0x00401e1b:	movs	r0, r0
0x00401e1d:	lsrs	r4, r5, #5
0x00401e1f:	movs	r0, r0
0x00401e21:	lsrs	r6, r6, #4
0x00401e23:	movs	r0, r0
0x00401e25:	lsrs	r6, r7, #3
0x00401e27:	movs	r0, r0
0x00401e29:	lsrs	r0, r7, #3
0x00401e2b:	movs	r0, r0
0x00401e2d:	lsrs	r4, r0, #3
0x00401e2f:	movs	r0, r0
0x00401e31:	lsrs	r2, r2, #2
0x00401e33:	movs	r0, r0
0x00401e35:	lsrs	r0, r4, #1
0x00401e37:	movs	r0, r0
0x00401e39:	lsrs	r6, r5, #0x20
0x00401e3b:	movs	r0, r0
0x00401e3d:	lsls	r0, r0, #0x1f
0x00401e3f:	movs	r0, r0
0x00401e41:	lsls	r2, r7, #0x1e
0x00401e43:	movs	r0, r0
0x00401e45:	lsls	r0, r7, #0x1e
0x00401e47:	movs	r0, r0
0x00401e49:	lsls	r4, r6, #0x1e
0x00401e4b:	movs	r0, r0
0x00401e4d:	lsls	r6, r7, #0x1b
0x00401e4f:	movs	r0, r0
0x00401e51:	lsls	r4, r1, #0x1b
0x00401e53:	movs	r0, r0
0x00401e55:	lsls	r2, r1, #0x1b
0x00401e57:	movs	r0, r0
0x00401e59:	lsls	r0, r1, #0x1b
0x00401e5b:	movs	r0, r0
0x00401e5d:	lsls	r4, r7, #0x1a
0x00401e5f:	movs	r0, r0
0x00401e61:	lsls	r4, r6, #0x1a
0x00401e63:	movs	r0, r0
0x00401e65:	lsls	r4, r5, #0x1a
0x00401e67:	movs	r0, r0
0x00401e69:	lsls	r4, r4, #0x1a
0x00401e6b:	movs	r0, r0
0x00401e6d:	lsls	r4, r3, #0x1a
0x00401e6f:	movs	r0, r0
0x00401e71:	lsls	r6, r2, #0x14
0x00401e73:	movs	r0, r0
0x00401e75:	lsls	r2, r1, #0x10
0x00401e77:	movs	r0, r0
0x00401e79:	lsls	r6, r0, #0x10
0x00401e7b:	movs	r0, r0
0x00401e7d:	lsls	r2, r2, #0xe
...
0x00401f5f:	bl	#0x500019
0x00401f63:	ldr	r0, [r4, #0xc]
0x00401f65:	pop.w	{r4, lr}
0x00401f69:	b.w	#0x500019

Function initecc @ 0x00401f71
...
0x00401fef:	nop	
0x00401ff1:	lsls	r0, r6, #3
0x00401ff3:	movs	r0, r0
0x00401ff5:	lsls	r4, r5, #3
...
Function initeccsize @ 0x00401ff9
0x00401ff9:	ldr	r2, [pc, #0x54]
0x00401ffb:	mov.w	ip, #1
0x00401fff:	push	{r4, r5, r6, lr}
0x00402001:	add	r2, pc
...
0x0040206b:	b.w	#0x500019

Function sub_40206f @ 0x0040206f
0x0040206f:	nop	
0x00402071:	movs	r4, r2
0x00402073:	movs	r0, r0

Function calloc_beebs @ 0x00500001
...
Function malloc_beebs @ 0x0050000d
...
Function free_beebs @ 0x00500019
