...
Function PackBitsDecode @ 0x00400285
...
Function PackBitsEncodeChunk @ 0x00400351
0x00400351:	push.w	{r4, r5, r6, r7, r8, lr}
0x00400355:	ldr.w	r6, [r0, #0x1c4]
0x00400359:	cmp	r6, #0
0x0040035b:	ble	#0x400391
...
0x004003a3:	nop	
0x004003a5:	lsls	r4, r0, #4
0x004003a7:	movs	r0, r0
0x004003a9:	lsls	r6, r5, #2
0x004003ab:	movs	r0, r0
0x004003ad:	lsls	r4, r6, #3
...
Function PackBitsPreEncode @ 0x004003b1
0x004003b1:	ldr	r3, [r0, #0xc]
0x004003b3:	push	{r4, lr}
0x004003b5:	mov	r4, r0
0x004003b7:	lsls	r3, r3, #0x15
...
Function TIFFInitPackBits @ 0x004003d5
0x004003d5:	ldr	r3, [pc, #0x30]
0x004003d7:	ldr	r2, [pc, #0x34]
0x004003d9:	ldr.w	ip, [pc, #0x34]
0x004003dd:	add	r3, pc
...
Function TIFFTileRowSize @ 0x0050003d
...
Function TIFFScanlineSize @ 0x00500049
