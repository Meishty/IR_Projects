...
0x00400285:	subs	r0, r2, r4
0x00400287:	movs	r0, r0
0x00400289:	asrs	r4, r0, #0x1a
0x0040028b:	movs	r0, r0
0x0040028d:	asrs	r6, r0, #0x19
0x0040028f:	movs	r0, r0
0x00400291:	asrs	r4, r7, #0x16
0x00400293:	movs	r0, r0
0x00400295:	asrs	r6, r2, #0x16
0x00400297:	movs	r0, r0
0x00400299:	asrs	r2, r6, #0x15
...
Function choose_table_short @ 0x0040029d
0x0040029d:	ldr.w	ip, [pc, #0x314]
0x004002a1:	cmp	r0, r1
0x004002a3:	add	ip, pc
0x004002a5:	bhs.w	#0x40058b
...
0x004005bd:	adds	r0, r0, r0
0x004005bf:	movs	r0, r0
0x004005c1:	asrs	r4, r4, #0xd
0x004005c3:	movs	r0, r0
0x004005c5:	asrs	r6, r5, #0xb
0x004005c7:	movs	r0, r0
0x004005c9:	asrs	r2, r0, #0xb
0x004005cb:	movs	r0, r0
0x004005cd:	asrs	r4, r3, #0xa
0x004005cf:	movs	r0, r0
0x004005d1:	asrs	r6, r0, #9
...
Function count_bits @ 0x004005d5
0x004005d5:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x004005d9:	mov	r5, r3
0x004005db:	ldr	r4, [pc, #0x274]
0x004005dd:	ldr	r3, [pc, #0x274]
...
0x0040086d:	lsrs	r6, r2, #0x1f
0x0040086f:	movs	r0, r0
0x00400871:	lsrs	r2, r6, #0x1e
...
Function best_huffman_divide @ 0x00400875
0x00400875:	ldr	r0, [pc, #0x330]
0x00400877:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp, lr}
0x0040087b:	mov	fp, r3
0x0040087d:	ldr	r3, [pc, #0x32c]
...
0x00400b6d:	bl	#0x500025

Function best_scalefac_store @ 0x00400bbd
...
0x004016f9:	lsrs	r2, r7, #1
0x004016fb:	movs	r0, r0
0x004016fd:	lsls	r0, r7, #0x17
0x004016ff:	movs	r0, r0
0x00401701:	lsls	r0, r5, #0x17
0x00401703:	movs	r0, r0

Function quantize_xrpow @ 0x00500001
...
Function quantize_xrpow_ISO @ 0x0050000d
...
Function scale_bitcount_lsf @ 0x00500031
...
Function scale_bitcount @ 0x0050003d
