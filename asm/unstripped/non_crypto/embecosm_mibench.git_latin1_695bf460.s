...
Function id3_latin1_length @ 0x00400001
...
Function id3_latin1_size @ 0x00400019
0x00400019:	ldrb	r3, [r0]
0x0040001b:	cbz	r3, #0x40002d
0x0040001d:	mov	r3, r0
0x0040001f:	ldrb	r2, [r3, #1]!
...
Function id3_latin1_copy @ 0x00400031
...
Function id3_latin1_duplicate @ 0x00400041
...
Function id3_latin1_decodechar @ 0x00400071
...
Function id3_latin1_encodechar @ 0x0040007d
0x0040007d:	mov	r3, r0
0x0040007f:	cmp.w	r1, #0x100
0x00400083:	it	hs
0x00400085:	movhs	r1, #0xb7
...
Function id3_latin1_decode @ 0x0040008d
...
Function id3_latin1_encode @ 0x0040009d
...
Function id3_latin1_put @ 0x004000c1
...
Function id3_latin1_get @ 0x004000d1
0x004000d1:	ldr	r3, [r0]
0x004000d3:	adds	r2, r3, #1
0x004000d5:	str	r2, [r0]
0x004000d7:	ldrb	r0, [r3]
...
Function id3_latin1_serialize @ 0x004000dd
0x004000dd:	ldr	r3, [r1]
0x004000df:	push	{r4, r5, r6}
0x004000e1:	mov	r4, r0
0x004000e3:	cbz	r3, #0x40013b
...
Function id3_latin1_deserialize @ 0x00400141
0x00400141:	push	{r4, r5, r6, lr}
0x00400143:	mov	r4, r0
0x00400145:	adds	r0, r1, #1
0x00400147:	ldr	r6, [r4]
