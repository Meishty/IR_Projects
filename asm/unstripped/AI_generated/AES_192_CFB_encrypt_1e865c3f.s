...
/root/projects/compiled/AI_generated/unstripped/AES_192_CFB_encrypt_1e865c3f.o:     file format elf32-littlearm
...
00000000 <main>:
 ...
 432:	4694      	mov	ip, r2
 434:	9d1c      	ldr	r5, [sp, #112]	; 0x70
 436:	4637      	mov	r7, r6
 438:	f8dd 8014 	ldr.w	r8, [sp, #20]
 43c:	f895 20c4 	ldrb.w	r2, [r5, #196]	; 0xc4
 440:	ea8e 0202 	eor.w	r2, lr, r2
 444:	f082 066f 	eor.w	r6, r2, #111	; 0x6f
 448:	f895 20c8 	ldrb.w	r2, [r5, #200]	; 0xc8
 44c:	ea87 0b02 	eor.w	fp, r7, r2
 450:	f895 20c0 	ldrb.w	r2, [r5, #192]	; 0xc0
 454:	f08b 0745 	eor.w	r7, fp, #69	; 0x45
 458:	ea80 0e02 	eor.w	lr, r0, r2
 45c:	f895 20c5 	ldrb.w	r2, [r5, #197]	; 0xc5
 460:	f08e 0148 	eor.w	r1, lr, #72	; 0x48
 464:	ea8a 0a02 	eor.w	sl, sl, r2
 468:	f895 20c9 	ldrb.w	r2, [r5, #201]	; 0xc9
 46c:	9d07      	ldr	r5, [sp, #28]
 46e:	f08a 002c 	eor.w	r0, sl, #44	; 0x2c
 472:	4055      	eors	r5, r2
 474:	9a1c      	ldr	r2, [sp, #112]	; 0x70
 476:	f085 0553 	eor.w	r5, r5, #83	; 0x53
 47a:	f892 20c1 	ldrb.w	r2, [r2, #193]	; 0xc1
 47e:	4062      	eors	r2, r4
 480:	2400      	movs	r4, #0
 482:	f082 0265 	eor.w	r2, r2, #101	; 0x65
 486:	f361 0407 	bfi	r4, r1, #0, #8
 48a:	2100      	movs	r1, #0
 48c:	f367 0107 	bfi	r1, r7, #0, #8
 490:	f362 240f 	bfi	r4, r2, #8, #8
 494:	2200      	movs	r2, #0
 496:	f365 210f 	bfi	r1, r5, #8, #8
 49a:	9d1c      	ldr	r5, [sp, #112]	; 0x70
 49c:	f366 0207 	bfi	r2, r6, #0, #8
 4a0:	9e06      	ldr	r6, [sp, #24]
 4a2:	f360 220f 	bfi	r2, r0, #8, #8
 4a6:	f895 00c6 	ldrb.w	r0, [r5, #198]	; 0xc6
 4aa:	4046      	eors	r6, r0
 4ac:	f086 0020 	eor.w	r0, r6, #32
 4b0:	9e03      	ldr	r6, [sp, #12]
 4b2:	f360 4217 	bfi	r2, r0, #16, #8
 4b6:	f895 00ca 	ldrb.w	r0, [r5, #202]	; 0xca
 4ba:	4046      	eors	r6, r0
 4bc:	f086 002d 	eor.w	r0, r6, #45	; 0x2d
 4c0:	f360 4117 	bfi	r1, r0, #16, #8
 4c4:	f895 00c2 	ldrb.w	r0, [r5, #194]	; 0xc2
 4c8:	4043      	eors	r3, r0
 4ca:	4640      	mov	r0, r8
 4cc:	f083 036c 	eor.w	r3, r3, #108	; 0x6c
 4d0:	f363 4417 	bfi	r4, r3, #16, #8
 4d4:	f895 30c7 	ldrb.w	r3, [r5, #199]	; 0xc7
 4d8:	4058      	eors	r0, r3
 4da:	f080 0341 	eor.w	r3, r0, #65	; 0x41
 4de:	9801      	ldr	r0, [sp, #4]
 4e0:	f363 621f 	bfi	r2, r3, #24, #8
 4e4:	f895 30cb 	ldrb.w	r3, [r5, #203]	; 0xcb
 4e8:	4058      	eors	r0, r3
 4ea:	f080 0331 	eor.w	r3, r0, #49	; 0x31
 4ee:	a823      	add	r0, sp, #140	; 0x8c
 4f0:	f363 611f 	bfi	r1, r3, #24, #8
 4f4:	f895 30c3 	ldrb.w	r3, [r5, #195]	; 0xc3
 4f8:	9125      	str	r1, [sp, #148]	; 0x94
 4fa:	ea89 0303 	eor.w	r3, r9, r3
 4fe:	9900      	ldr	r1, [sp, #0]
 500:	f083 036c 	eor.w	r3, r3, #108	; 0x6c
 504:	f363 641f 	bfi	r4, r3, #24, #8
 508:	f895 30cc 	ldrb.w	r3, [r5, #204]	; 0xcc
 50c:	e9cd 4223 	strd	r4, r2, [sp, #140]	; 0x8c
 510:	4059      	eors	r1, r3
 512:	4c23      	ldr	r4, [pc, #140]	; (5a0 <main+0x5a0>)
 514:	f081 0339 	eor.w	r3, r1, #57	; 0x39
 518:	9904      	ldr	r1, [sp, #16]
 51a:	f88d 3098 	strb.w	r3, [sp, #152]	; 0x98
 51e:	447c      	add	r4, pc
 520:	f895 30cd 	ldrb.w	r3, [r5, #205]	; 0xcd
 524:	4059      	eors	r1, r3
 526:	f081 0332 	eor.w	r3, r1, #50	; 0x32
 52a:	f88d 3099 	strb.w	r3, [sp, #153]	; 0x99
 52e:	f895 30ce 	ldrb.w	r3, [r5, #206]	; 0xce
 532:	4661      	mov	r1, ip
 534:	9a02      	ldr	r2, [sp, #8]
 536:	405a      	eors	r2, r3
 538:	f895 30cf 	ldrb.w	r3, [r5, #207]	; 0xcf
 53c:	4605      	mov	r5, r0
 53e:	2001      	movs	r0, #1
 540:	4059      	eors	r1, r3
 542:	f88d 109b 	strb.w	r1, [sp, #155]	; 0x9b
 546:	4917      	ldr	r1, [pc, #92]	; (5a4 <main+0x5a4>)
 548:	f082 0321 	eor.w	r3, r2, #33	; 0x21
 54c:	f88d 309a 	strb.w	r3, [sp, #154]	; 0x9a
 550:	4479      	add	r1, pc
 552:	f7ff fffe 	bl	0 <__printf_chk>
 556:	9e1d      	ldr	r6, [sp, #116]	; 0x74
 558:	f815 2b01 	ldrb.w	r2, [r5], #1
 55c:	4621      	mov	r1, r4
 55e:	2001      	movs	r0, #1
 560:	f7ff fffe 	bl	0 <__printf_chk>
 564:	42ae      	cmp	r6, r5
 566:	d1f7      	bne.n	558 <main+0x558>
 568:	200a      	movs	r0, #10
 56a:	f7ff fffe 	bl	0 <putchar>
 56e:	4a0e      	ldr	r2, [pc, #56]	; (5a8 <main+0x5a8>)
 570:	4b09      	ldr	r3, [pc, #36]	; (598 <main+0x598>)
 572:	447a      	add	r2, pc
 574:	58d3      	ldr	r3, [r2, r3]
 576:	681a      	ldr	r2, [r3, #0]
 578:	9ba1      	ldr	r3, [sp, #644]	; 0x284
 57a:	405a      	eors	r2, r3
 57c:	f04f 0300 	mov.w	r3, #0
 580:	d104      	bne.n	58c <main+0x58c>
 582:	2000      	movs	r0, #0
 584:	f50d 7d23 	add.w	sp, sp, #652	; 0x28c
 ...
 5a0:	0000007e 	.word	0x0000007e
 5a4:	00000050 	.word	0x00000050
 5a8:	00000032 	.word	0x00000032
