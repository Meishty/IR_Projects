...
0x004005eb:	nop	
0x004005ed:	lsls	r2, r1, #4
0x004005ef:	movs	r0, r0
0x004005f1:	lsls	r0, r5, #3
...
0x004010ad:	bl	#0x4010ad
0x004010b1:	lsls	r0, r5, #0x1d
0x004010b3:	movs	r0, r0
0x004010b5:	movs	r0, r0
0x004010b7:	movs	r0, r0
0x004010b9:	lsls	r6, r3, #0x1d
0x004010bb:	movs	r0, r0
0x004010bd:	lsls	r0, r3, #0x1d
0x004010bf:	movs	r0, r0
0x004010c1:	lsls	r0, r2, #0x1d
0x004010c3:	movs	r0, r0
0x004010c5:	lsls	r4, r7, #0x1c
0x004010c7:	movs	r0, r0
0x004010c9:	lsls	r4, r7, #0x1c
0x004010cb:	movs	r0, r0
0x004010cd:	lsls	r2, r1, #0x19
0x004010cf:	movs	r0, r0
0x004010d1:	lsls	r6, r0, #0x19
0x004010d3:	movs	r0, r0
0x004010d5:	lsls	r2, r0, #0x19
0x004010d7:	movs	r0, r0
0x004010d9:	lsls	r4, r1, #3
0x004010db:	movs	r0, r0
0x004010dd:	lsls	r2, r0, #2
0x004010df:	movs	r0, r0
0x004010e1:	lsls	r4, r4, #1
0x004010e3:	movs	r0, r0
0x004010e5:	movs	r0, r0
0x004010e7:	movs	r0, r0
0x004010e9:	lsls	r0, r1, #1
