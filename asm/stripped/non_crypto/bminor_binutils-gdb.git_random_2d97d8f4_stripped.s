...
0x00400089:	lsls	r6, r7, #1
0x0040008b:	movs	r0, r0
0x0040008d:	lsls	r0, r0, #2
0x0040008f:	movs	r0, r0
0x00400091:	lsls	r2, r0, #1
0x00400093:	movs	r0, r0
0x00400095:	movs	r4, r3
...
0x00400163:	nop	
0x00400165:	lsls	r6, r7, #2
0x00400167:	movs	r0, r0
0x00400169:	lsls	r0, r0, #3
0x0040016b:	movs	r0, r0
0x0040016d:	lsls	r0, r3, #2
0x0040016f:	movs	r0, r0
0x00400171:	lsls	r2, r2, #2
0x00400173:	movs	r0, r0
0x00400175:	lsls	r2, r6, #1
0x00400177:	movs	r0, r0
0x00400179:	lsls	r4, r6, #1
...
0x004002a7:	nop	
0x004002a9:	lsls	r2, r4, #1
0x004002ab:	movs	r0, r0
0x004002ad:	lsls	r2, r2, #1
0x004002af:	movs	r0, r0
0x004002b1:	lsls	r0, r0, #1
