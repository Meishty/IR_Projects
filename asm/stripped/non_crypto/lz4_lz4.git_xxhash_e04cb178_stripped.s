...
0x0040000d:	cmp	r3, #0x1e
0x0040000f:	bhi.w	#0x40031d
0x00400017:	lsls	r7, r3, #5
0x00400019:	lsls	r2, r7, #4
0x0040001b:	lsls	r5, r2, #4
0x0040001d:	lsls	r3, r4, #0xe
0x0040001f:	lsls	r3, r6, #9
0x00400021:	lsls	r3, r6, #0x12
0x00400023:	lsls	r5, r4, #3
0x00400025:	lsls	r6, r0, #0x1b
0x00400027:	lsls	r3, r7, #0x16
0x00400029:	lsls	r6, r4, #0x1e
0x0040002b:	lsrs	r1, r7, #2
0x0040002d:	lsls	r1, r4, #0xd
0x0040002f:	lsls	r1, r6, #8
0x00400031:	lsls	r1, r6, #0x11
0x00400033:	lsls	r3, r4, #2
0x00400035:	lsls	r4, r0, #0x1a
0x00400037:	lsls	r1, r7, #0x15
0x00400039:	lsls	r4, r4, #0x1d
0x0040003b:	lsrs	r7, r6, #1
0x0040003d:	lsls	r7, r3, #0xc
0x0040003f:	lsls	r7, r5, #7
0x00400041:	lsls	r7, r5, #0x10
0x00400043:	lsls	r1, r4, #1
0x00400045:	lsls	r2, r0, #0x19
0x00400047:	lsls	r7, r6, #0x14
0x00400049:	lsls	r2, r4, #0x1c
0x0040004b:	lsrs	r5, r6, #0x20
0x0040004d:	lsls	r5, r3, #0xb
0x0040004f:	lsls	r5, r5, #6
0x00400051:	lsls	r5, r5, #0xf
0x00400053:	movs	r7, r3
...
Function sub_402853 @ 0x00402853
0x00402853:	bl	#0x402853
