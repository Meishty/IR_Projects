...
0x00403165:	bl	#0x403165
0x004031c1:	strd	r3, r1, [sp, #0x3c]
0x004031c5:	bl	#0x4031c5
...
0x00400c0d:	mov	r0, r8
0x00400c0f:	movs	r0, r0
0x00400c11:	lsls	r4, r7, #8
0x00400c13:	movs	r0, r0
0x00400c15:	movs	r3, #0xfe
0x00400c17:	movs	r0, r0
0x00400c19:	ldm	r5!, {r1, r2, r3, r4, r6}
0x00400c1b:	movs	r1, r0
0x00400c1d:	lsls	r0, r6, #7
0x00400c1f:	movs	r0, r0
0x00400c21:	ldrh	r4, [r6, #0x28]
0x00400c23:	movs	r1, r0
0x00400c25:	lsrs	r0, r5, #0x15
0x00400c27:	movs	r2, r0
0x00400c29:	adds	r4, #0xb8
0x00400c2b:	movs	r0, r0
0x00400c2d:	strb	r0, [r6, #0x13]
0x00400c2f:	movs	r0, r0
0x00400c31:	strb	r2, [r6, r3]
0x00400c33:	movs	r0, r0
0x00400c35:	lsls	r0, r7, #2
...
0x00400fb1:	lsls	r0, r1, #9
0x00400fb3:	movs	r0, r0
0x00400fb5:	adds	r5, #0x1a
0x00400fb7:	movs	r0, r0
0x00400fb9:	adds	r3, #0x8c
0x00400fbb:	movs	r0, r0
0x00400fbd:	movs	r2, #0x92
0x00400fbf:	movs	r0, r0
0x00400fc1:	lsls	r0, r4, #2
0x00400fc3:	movs	r0, r0
0x00400fc5:	movs	r2, #0x92
0x00400fc7:	movs	r0, r0
0x00400fc9:	movs	r2, #0x90
...
0x00401761:	movs	r5, #0x58
0x00401763:	movs	r0, r0
0x00401765:	adds	r6, #0x50
0x00401767:	movs	r0, r0
0x00401769:	ldrh	r6, [r4, #0x34]
0x0040176b:	movs	r0, r0
0x0040176d:	movs	r4, #0xf4
0x0040176f:	movs	r0, r0
0x00401771:	lsls	r0, r1, #7
0x00401773:	movs	r0, r0
0x00401775:	movs	r3, #0xba
0x00401777:	movs	r0, r0
0x00401779:	ldm	r5, {r1, r3, r5}
0x0040177b:	movs	r1, r0
0x0040177d:	ldrh	r6, [r0, #0x28]
0x0040177f:	movs	r1, r0
0x00401781:	lsrs	r2, r0, #0x15
0x00401783:	movs	r2, r0
0x00401785:	movs	r3, #0xa6
0x00401787:	movs	r0, r0
0x00401789:	movs	r3, #0xa0
0x0040178b:	movs	r0, r0
0x0040178d:	strb	r6, [r0, #0x13]
0x0040178f:	movs	r0, r0
0x00401791:	strb	r0, [r0, r3]
0x00401793:	movs	r0, r0
0x00401795:	movs	r3, #0x26
0x00401797:	movs	r0, r0
0x00401799:	lsls	r2, r6, #1
...
Function sub_401a3f @ 0x00401a3f
...
0x0040219f:	lsls	r4, r0, #0x11
0x004021a1:	lsls	r2, r1, #0x1e
0x004021a3:	lsls	r6, r1, #0x11
0x004021a5:	lsls	r4, r0, #0x11
0x004021a7:	vmov.f64	d0, d9
0x004021ab:	b	#0x401d77

Function sub_4021cd @ 0x004021cd
0x004021cd:	bl	#0x4021cd
...
Function sub_402291 @ 0x00402291
0x00402291:	lsls	r7, r0, #0xf
0x00402293:	lsls	r1, r2, #0x1c
0x00402295:	lsls	r1, r3, #0xf
0x00402297:	lsls	r7, r0, #0xf
0x00402299:	movs	r0, r0
0x0040229b:	movs	r0, r0
0x0040229d:	movs	r0, r0
0x0040229f:	movs	r0, r0
0x004022a1:	add	r1, sp, #0x3e4
0x004022a3:	stm	r3!, {r3, r4, r5, r6, r7}
0x004022a5:	movs	r7, #0xa
0x004022a7:	subs	r7, #0xb0
0x004022a9:	lsls	r3, r4, #0x17
0x004022ab:	cbz	r1, #0x402307
0x004022ad:	lsls	r0, r3, #0xa
0x004022af:	subs	r7, #0xf3
0x004022b1:	strh	r7, [r4, #0x32]
0x004022b3:	b	#0x401ac5
...
0x00402609:	lsls	r2, r5, #0xc
0x0040260b:	movs	r0, r0
0x0040260d:	lsls	r2, r0, #0xb
...
Function sub_40288f @ 0x0040288f
0x0040288f:	bl	#0x40288f
...
Function sub_4029df @ 0x004029df
0x004029df:	bl	#0x4029df

Function sub_4029e3 @ 0x004029e3
0x004029e3:	mov.w	r0, #-1
0x004029e7:	bl	#0x4029e7
...
Function sub_402ab5 @ 0x00402ab5
...
Function sub_402b0b @ 0x00402b0b
...
0x00402b35:	bl	#0x402b35

Function sub_402b35 @ 0x00402b35
0x00402b35:	bl	#0x402b35
...
0x00402b55:	bl	#0x402b55

Function sub_402b55 @ 0x00402b55
0x00402b55:	bl	#0x402b55
...
0x00402d1d:	lsls	r6, r7, #0xc
0x00402d1f:	movs	r0, r0
0x00402d21:	lsls	r4, r7, #0xa
0x00402d23:	movs	r0, r0
0x00402d25:	asrs	r4, r6, #0xd
0x00402d27:	movs	r0, r0
0x00402d29:	asrs	r6, r4, #0xc
0x00402d2b:	movs	r0, r0
0x00402d2d:	asrs	r6, r2, #0xb
0x00402d2f:	movs	r0, r0
0x00402d31:	movs	r3, #0xb2
0x00402d33:	movs	r0, r0
0x00402d35:	ldrh	r4, [r0, #0x28]
0x00402d37:	movs	r0, r0
0x00402d39:	lsrs	r2, r0, #0x14
0x00402d3b:	movs	r1, r0
0x00402d3d:	movs	r3, #0x3a
0x00402d3f:	movs	r0, r0
0x00402d41:	movs	r3, #0x20
0x00402d43:	movs	r0, r0
0x00402d45:	movs	r2, #0xdc
0x00402d47:	movs	r0, r0
0x00402d49:	movs	r2, #0xbc
0x00402d4b:	movs	r0, r0
0x00402d4d:	lsrs	r6, r1, #0x10
0x00402d4f:	movs	r1, r0
0x00402d51:	movs	r2, #0x52
0x00402d53:	movs	r0, r0
0x00402d55:	ldrh	r6, [r4, #0x1c]
...
Function sub_403171 @ 0x00403171
0x00403171:	bl	#0x403171
0x00403175:	b.w	#0x400ef5

Function sub_403181 @ 0x00403181
0x00403181:	bl	#0x403181
0x00403185:	vmov.f32	s17, s0
0x00403189:	b.w	#0x401929

Function sub_40318d @ 0x0040318d
0x0040318d:	bl	#0x40318d
