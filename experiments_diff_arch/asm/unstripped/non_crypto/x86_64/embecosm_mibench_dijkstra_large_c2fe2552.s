...
0x00400000:	push	rax
0x00400001:	pop	rax
0x00400002:	lea	rdi, [rip + 0xa51f]
0x00400009:	mov	edx, 0xf
0x0040000e:	mov	esi, 1
0x00400013:	sub	rsp, 8
0x00400017:	mov	rcx, qword ptr [rip + 0xfffe2]
0x0040001e:	call	0x500008
0x00400023:	mov	edi, 1
0x00400028:	call	0x500010
...
0x00400048:	lea	rbp, [rip + 0xa4e9]
0x0040004f:	cmp	r13d, 0x270f
0x00400056:	jne	0x400080

Function print_path @ 0x00400030
0x00400030:	endbr64	
0x00400034:	movsxd	rax, esi
0x00400037:	push	r15
0x00400039:	push	r14
...
0x00400065:	call	0x500018
0x0040006a:	mov	rdi, qword ptr [rip + 0xfffaf]
0x00400071:	pop	rbp
0x00400072:	pop	r12
0x00400074:	pop	r13
0x00400076:	pop	r14
0x00400078:	pop	r15
0x0040007a:	jmp	0x500028
...
0x004000af:	call	0x500018
0x004000b4:	mov	rdi, qword ptr [rip + 0xfff65]
0x004000bb:	call	0x500028
0x004000c0:	mov	edx, r13d
0x004000c3:	mov	rsi, rbp
0x004000c6:	mov	edi, 1
0x004000cb:	xor	eax, eax
0x004000cd:	call	0x500018
0x004000d2:	mov	rdi, qword ptr [rip + 0xfff47]
0x004000d9:	call	0x500028
...
0x004000f7:	call	0x400030
0x004000fc:	lea	rbp, [rip + 0xa435]
0x00400103:	mov	edx, r15d
0x00400106:	mov	edi, 1
0x0040010b:	xor	eax, eax
0x0040010d:	mov	rsi, rbp
0x00400110:	call	0x500018
0x00400115:	mov	rdi, qword ptr [rip + 0xfff04]
0x0040011c:	call	0x500028
...
0x00400152:	call	0x500030

Function enqueue @ 0x00400130
0x00400130:	endbr64	
0x00400134:	push	rbx
0x00400135:	movd	xmm0, edi
0x00400139:	movd	xmm1, esi
...
0x0040014c:	movq	qword ptr [rsp + 8], xmm0
0x00400152:	call	0x500030
0x00400157:	mov	rcx, qword ptr [rip + 0xa3c2]
...
0x00400190:	add	dword ptr [rip + 0x729], 1
0x00400197:	add	rsp, 0x10
0x0040019b:	pop	rbx
0x0040019c:	ret	
0x004001a0:	add	dword ptr [rip + 0x719], 1
0x004001a7:	mov	qword ptr [rip + 0xa372], rax
...
0x004001c7:	mov	rdi, qword ptr [rip + 0xa352]
0x004001ce:	test	rdi, rdi
0x004001d1:	je	0x400208

Function dequeue @ 0x004001c0
0x004001c0:	endbr64	
0x004001c4:	mov	rax, rdi
0x004001c7:	mov	rdi, qword ptr [rip + 0xa352]
0x004001ce:	test	rdi, rdi
0x004001d1:	je	0x400208
0x004001d3:	sub	rsp, 8
0x004001d7:	mov	ecx, dword ptr [rdi]
0x004001d9:	mov	dword ptr [rax], ecx
0x004001db:	mov	eax, dword ptr [rdi + 4]
0x004001de:	mov	dword ptr [rsi], eax
0x004001e0:	mov	eax, dword ptr [rdi + 8]
0x004001e3:	mov	dword ptr [rdx], eax
0x004001e5:	mov	rax, qword ptr [rdi + 0x10]
0x004001e9:	mov	qword ptr [rip + 0xa330], rax
0x004001f0:	call	0x500038
0x004001f5:	sub	dword ptr [rip + 0x6c4], 1
...
0x00400210:	endbr64	
0x00400214:	mov	eax, dword ptr [rip + 0x6a6]
0x0040021a:	ret	

Function qcount @ 0x00400210
0x00400210:	endbr64	
0x00400214:	mov	eax, dword ptr [rip + 0x6a6]
0x0040021a:	ret	
...
0x00400245:	movdqa	xmm0, xmmword ptr [rip + 0xa4b3]
...
0x004002d8:	mov	eax, dword ptr [rip + 0x5e2]
0x004002de:	add	eax, 1
0x004002e1:	mov	dword ptr [rip + 0x5d9], eax
...
0x00400307:	mov	dword ptr [rip + 0x27f], eax
0x0040030d:	mov	eax, dword ptr [rdi + 4]
0x00400310:	mov	dword ptr [rip + 0x26a], eax
0x00400316:	mov	eax, dword ptr [rdi + 8]
0x00400319:	mov	dword ptr [rip + 0x271], eax
0x0040031f:	mov	rax, qword ptr [rdi + 0x10]
0x00400323:	mov	qword ptr [rip + 0xa1f6], rax
0x0040032a:	call	0x500038
0x0040032f:	sub	dword ptr [rip + 0x58a], 1
0x00400336:	movsxd	rax, dword ptr [rip + 0x24f]
0x0040033d:	xor	ebx, ebx
0x0040033f:	mov	dword ptr [rip + 0x23f], 0
...
0x00400368:	mov	dword ptr [rip + 0x216], eax
...
0x0040036e:	cmp	eax, 0x270f
0x00400373:	je	0x4003ff
0x00400379:	add	eax, dword ptr [rip + 0x201]
...
0x004003b7:	call	0x500030
0x004003bc:	mov	rdx, qword ptr [rip + 0xa15d]
...
0x004003f8:	add	dword ptr [rip + 0x4c1], 1
0x004003ff:	add	r14d, 1
0x00400403:	add	rbx, 1
0x00400407:	mov	dword ptr [rip + 0x17a], r14d
...
0x0040049b:	call	0x500018
0x004004a0:	mov	rdi, qword ptr [rip + 0xffb79]
0x004004a7:	call	0x500028
0x004004ac:	mov	edx, dword ptr [rsp + 0xc]
0x004004b0:	mov	rsi, rbp
0x004004b3:	mov	edi, 1
0x004004b8:	xor	eax, eax
0x004004ba:	call	0x500018
0x004004bf:	mov	rdi, qword ptr [rip + 0xffb5a]
0x004004c6:	call	0x500028
...
0x004004da:	pop	r14
0x004004dc:	pop	r15
0x004004de:	jmp	0x500040
0x004004e3:	add	rsp, 0x18
0x004004e7:	lea	rdi, [rip + 0xa09a]
0x004004ee:	pop	rbx
0x004004ef:	pop	rbp
0x004004f0:	pop	r12
0x004004f2:	pop	r13
0x004004f4:	pop	r14
0x004004f6:	pop	r15
0x004004f8:	jmp	0x500048
0x004004fd:	mov	qword ptr [rip + 0xa01c], rax
...
0x0040051f:	call	0x400030
0x00400524:	lea	rbp, [rip + 0xa00d]
0x0040052b:	mov	edx, r14d
0x0040052e:	mov	edi, 1
0x00400533:	xor	eax, eax
0x00400535:	mov	rsi, rbp
0x00400538:	call	0x500018
0x0040053d:	mov	rdi, qword ptr [rip + 0xffadc]
0x00400544:	call	0x500028
0x00400549:	jmp	0x40048e
0x0040054e:	mov	rcx, qword ptr [rip + 0xffaab]
0x00400555:	mov	edx, 0xf
0x0040055a:	mov	esi, 1
0x0040055f:	lea	rdi, [rip + 0x9fc2]
0x00400566:	call	0x500008
0x0040056b:	mov	edi, 1
0x00400570:	call	0x500010
...
0x0040a622:	lea	rsi, [rip - 0xa9]
0x0040a629:	lea	rbp, [rip - 0x9bc0]
0x0040a630:	lea	r15, [rbp + 0x9c40]
0x0040a637:	lea	r14, [rsp + 4]
0x0040a63c:	call	0x500050
0x0040a641:	lea	r13, [rip - 0xc6]
