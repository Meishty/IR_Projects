...
0x00400000:	push	ebx
0x00400001:	call	0x40a7d9
0x00400006:	add	ebx, 0xffffa
...
0x0040001f:	push	1
0x00400021:	push	eax
0x00400022:	call	0x500008
0x00400027:	mov	dword ptr [esp], 1
0x0040002e:	call	0x500010
...
0x00400042:	push	esi
0x00400043:	push	ebx
0x00400044:	call	0x40a7d9

Function print_path @ 0x00400040
0x00400040:	push	ebp
0x00400041:	push	edi
0x00400042:	push	esi
0x00400043:	push	ebx
0x00400044:	call	0x40a7d9
0x00400049:	add	ebx, 0xfffb7
...
0x0040015e:	nop	
0x00400160:	push	ebx
0x00400161:	call	0x40a7d9

Function enqueue @ 0x00400160
0x00400160:	push	ebx
0x00400161:	call	0x40a7d9
0x00400166:	add	ebx, 0xffe9a
0x0040016c:	sub	esp, 0x14
0x0040016f:	push	0x10
0x00400171:	call	0x500028
...
0x004001de:	nop	
0x004001e0:	push	ebx
0x004001e1:	call	0x40a7d9

Function dequeue @ 0x004001e0
0x004001e0:	push	ebx
0x004001e1:	call	0x40a7d9
0x004001e6:	add	ebx, 0xffe1a
...
0x0040023f:	nop	
0x00400240:	call	0x40a7d1

Function qcount @ 0x00400240
0x00400240:	call	0x40a7d1
0x00400245:	add	eax, 0xffdbb
...
0x0040025f:	nop	
0x00400260:	call	0x40a7d5

Function dijkstra @ 0x00400260
0x00400260:	call	0x40a7d5
0x00400265:	add	ecx, 0xffd9b
0x0040026b:	push	ebp
0x0040026c:	push	edi
0x0040026d:	push	esi
0x0040026e:	push	ebx
...
0x0040a6be:	push	esi
0x0040a6bf:	push	ebx
0x0040a6c0:	call	0x40a7d9
0x0040a6c5:	add	ebx, 0xf593b
0x0040a6cb:	push	ecx
