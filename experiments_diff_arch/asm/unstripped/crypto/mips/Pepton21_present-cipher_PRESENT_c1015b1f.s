...
Function fromBytesToLong @ 0x004004f4
...
Function fromHexStringToLong @ 0x0040061c
0x0040061c:	lb	$a1, ($a0)
...
Function fromLongToBytes @ 0x00400c68
0x00400c68:	lui	$gp, 0x50
...
Function fromLongToHexString @ 0x00400d4c
0x00400d4c:	lui	$gp, 0x50
...
Function Sbox @ 0x00400dc0
0x00400dc0:	lui	$v0, 0x40
0x00400dc4:	addiu	$v0, $v0, 0x2540
0x00400dc8:	addu	$v0, $v0, $a0
0x00400dcc:	jr	$ra
0x00400dd0:	lbu	$v0, ($v0)

Function inverseSbox @ 0x00400dd4
0x00400dd4:	lui	$v0, 0x40
0x00400dd8:	addiu	$v0, $v0, 0x2530
0x00400ddc:	addu	$v0, $v0, $a0
0x00400de0:	jr	$ra
0x00400de4:	lbu	$v0, ($v0)

Function permute @ 0x00400de8
0x00400de8:	lui	$a3, 0x40
0x00400dec:	lui	$t4, 0x40
0x00400df0:	addiu	$a3, $a3, 0x24f0
0x00400df4:	move	$v0, $zero
0x00400df8:	addiu	$t7, $a3, 0x40
0x00400dfc:	move	$t2, $zero
0x00400e00:	addiu	$t4, $t4, 0x252f
...
Function inversepermute @ 0x00400e64
0x00400e64:	lui	$t0, 0x40
0x00400e68:	move	$v0, $zero
0x00400e6c:	addiu	$t0, $t0, 0x24f0
...
Function generateSubkeys @ 0x00400f7c
0x00400f7c:	lui	$gp, 0x50
...
Function encrypt @ 0x0040177c
0x0040177c:	addiu	$sp, $sp, -0x30
0x00401780:	lui	$gp, 0x50
...
0x00401acc:	lui	$v0, 0x40
0x00401ad0:	lui	$ra, 0x40
0x00401ad4:	lui	$t8, 0x40
0x00401ad8:	lui	$t7, 0x40
0x00401adc:	sra	$t2, $t1, 0x1f
0x00401ae0:	addiu	$s0, $s1, 0xf8
0x00401ae4:	addiu	$v0, $v0, 0x2540
0x00401ae8:	addiu	$ra, $ra, 0x24f0
0x00401aec:	addiu	$t8, $t8, 0x2530
0x00401af0:	addiu	$t7, $t7, 0x252f
...
Function decrypt @ 0x00401e44
0x00401e44:	addiu	$sp, $sp, -0x30
0x00401e48:	lui	$gp, 0x50
...
0x00402190:	lui	$a0, 0x40
0x00402194:	lui	$t5, 0x40
0x00402198:	lui	$t7, 0x40
0x0040219c:	sra	$t1, $a1, 0x1f
0x004021a0:	addiu	$t8, $v0, 0xf8
0x004021a4:	addiu	$a0, $a0, 0x24f0
0x004021a8:	addiu	$t5, $t5, 0x2530
0x004021ac:	addiu	$t7, $t7, 0x2530
...
Function main @ 0x00402690
0x00402690:	lui	$gp, 0x50
...
0x00402754:	lui	$a1, 0x40
0x00402758:	lw	$gp, 0x10($sp)
0x0040275c:	addiu	$a0, $zero, 1
0x00402760:	lw	$t9, ($gp)
0x00402764:	jalr	$t9
0x00402768:	addiu	$a1, $a1, 0x2670
0x0040276c:	move	$a1, $s0
0x00402770:	jal	0x401e44
...
[SECTION] .rel.text
  ...
  Size   : 544 bytes
  Flags  : 64
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 00 00 00 00 00 04 00 ff f1 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 03 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 09 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 0a 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 0b 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 0e 00 00 00 0b 00 00 00 00 00 00 00 00 00 00 00 0a 00 00 00 10 00 00 00 08 00 00 00 00 00 00 00 0a 00 00 00 15 00 00 00 74 00 00 00 00 00 00 00 0a 00 00 00 1a 00 00 00 dc 00 00 00 00 00 00 00 0a 00 00 00 1f 00 00 00 f0 00 00 00 00 00 00 00 0a 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 05 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 06

[SECTION] .strtab
  Address: 0x0
  Size   : 274 bytes
  Flags  : 0
  Data (first 256 bytes): 00 50 52 45 53 45 4e 54 2e 63 00 24 4c 43 30 00 24 4c 43 31 00 24 4c 43 32 00 24 4c 43 33 00 24 4c 43 34 00 66 72 6f 6d 48 65 78 53 74 72 69 6e 67 54 6f 42 79 74 65 73 00 5f 5f 67 6e 75 5f 6c 6f 63 61 6c 5f 67 70 00 6d 61 6c 6c 6f 63 00 66 72 6f 6d 42 79 74 65 73 54 6f 4c 6f 6e 67 00 66 72 6f 6d 48 65 78 53 74 72 69 6e 67 54 6f 4c 6f 6e 67 00 66 72 6f 6d 4c 6f 6e 67 54 6f 42 79 74 65 73 00 66 72 6f 6d 4c 6f 6e 67 54 6f 48 65 78 53 74 72 69 6e 67 00 5f 5f 73 70 72 69 6e 74 66 5f 63 68 6b 00 69 6e 76 65 72 73 65 53 62 6f 78 00 69 6e 76 53 00 50 00 69 6e 76 65 72 73 65 70 65 72 6d 75 74 65 00 67 65 74 4b 65 79 4c 6f 77 00 67 65 6e 65 72 61 74 65 53 75 62 6b 65 79 73 00 65 6e 63 72 79 70 74 00 66 72 65 65 00 64 65 63 72 79 70 74 00 6d 61 69 6e 00 70 75 74 73 00

[SECTION] .shstrtab
  Address: 0x0
  Size   : 169 bytes
  Flags  : 0
  Data (first 256 bytes): 00 2e 73 79 6d 74 61 62 00 2e 73 74 72 74 61 62 00 2e 73 68 73 74 72 74 61 62 00 2e 72 65 6c 2e 74 65 78 74 00 2e 64 61 74 61 00 2e 62 73 73 00 2e 72 65 67 69 6e 66 6f 00 2e 4d 49 50 53 2e 61 62 69 66 6c 61 67 73 00 2e 72 65 6c 2e 70 64 72 00 2e 6d 64 65 62 75 67 2e 61 62 69 33 32 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 34 00 2e 72 65 6c 2e 74 65 78 74 2e 73 74 61 72 74 75 70 00 2e 63 6f 6d 6d 65 6e 74 00 2e 6e 6f 74 65 2e 47 4e 55 2d 73 74 61 63 6b 00 2e 67 6e 75 2e 61 74 74 72 69 62 75 74 65 73 00
