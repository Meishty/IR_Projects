...
Function mixColumn @ 0x0040016e
0x0040016e:	lbu	a3, 0xa(a0)
0x00400172:	lbu	a5, 3(a0)
0x00400176:	lbu	t3, 0xb(a0)
0x00400614:	xor	t3, s0, a2
0x00400618:	xor	a2, s0, t0

Function addRoundKey @ 0x004006a0
0x004006a0:	lbu	a2, 0(a1)
0x004006a4:	lbu	a5, 0(a0)
0x004006a8:	lbu	a3, 1(a0)
0x004006ac:	lbu	a4, 2(a0)

Function nextRoundKey @ 0x0040078c

Function copy_data @ 0x004008ca
0x004008ca:	lbu	a5, 0(a1)
0x004008ce:	sb	a5, 0(a0)
0x004008d2:	lbu	a5, 1(a1)
0x004008d6:	sb	a5, 1(a0)
0x004008da:	lbu	a5, 2(a1)
0x004008de:	sb	a5, 2(a0)
0x004008e2:	lbu	a5, 3(a1)
0x004008e6:	sb	a5, 3(a0)
0x004008ea:	lbu	a5, 4(a1)
0x004008ee:	sb	a5, 4(a0)
0x004008f2:	lbu	a5, 5(a1)
0x004008f6:	sb	a5, 5(a0)
0x004008fa:	lbu	a5, 6(a1)
0x004008fe:	sb	a5, 6(a0)
0x00400902:	lbu	a5, 7(a1)
0x00400906:	sb	a5, 7(a0)
0x0040090a:	lbu	a5, 8(a1)
0x0040090e:	sb	a5, 8(a0)
0x00400912:	lbu	a5, 9(a1)
0x00400916:	sb	a5, 9(a0)
0x0040091a:	lbu	a5, 0xa(a1)
0x0040091e:	sb	a5, 0xa(a0)
0x00400922:	lbu	a5, 0xb(a1)
0x00400926:	sb	a5, 0xb(a0)
0x0040092a:	lbu	a5, 0xc(a1)
0x0040092e:	sb	a5, 0xc(a0)
0x00400932:	lbu	a5, 0xd(a1)
0x00400936:	sb	a5, 0xd(a0)
0x0040093a:	lbu	a5, 0xe(a1)
0x0040093e:	sb	a5, 0xe(a0)
0x00400942:	lbu	a5, 0xf(a1)
0x00400946:	sb	a5, 0xf(a0)

Function print_matrix @ 0x0040094c

Function sub_4009b0 @ 0x004009b0
0x004009b0:	auipc	ra, 0
0x004009b4:	jalr	ra

Function main @ 0x00400c82
0x00400c82:	addi	sp, sp, -0x2c0
