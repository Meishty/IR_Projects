...
0x00400208:	movdqa	xmm5, xmmword ptr [rip + 0x1290]
...
Function addRoundKey @ 0x004002b0
0x004002b0:	endbr64	
0x004002b4:	movzx	ecx, byte ptr [rsi]
0x004002b7:	xor	byte ptr [rdi], cl
0x004002b9:	movzx	ecx, byte ptr [rsi + 1]
...
Function nextRoundKey @ 0x00400330
0x00400330:	endbr64	
0x00400334:	push	r15
0x00400336:	mov	rcx, rdi
0x00400339:	push	r14
...
0x004005e2:	lea	rsi, [rip + 0x15f]
0x004005e9:	movzx	r8d, byte ptr [rdi + 2]
0x004005ee:	mov	edi, 1
0x004005f3:	call	0x500000

Function print_matrix @ 0x00400590
0x00400590:	endbr64	
0x00400594:	sub	rsp, 8
0x00400598:	movzx	esi, byte ptr [rdi + 0xf]
0x0040059c:	movzx	ecx, byte ptr [rdi + 1]
...
Function main @ 0x004008b0
0x004008b0:	endbr64	
0x004008b4:	push	r15
0x004008b6:	lea	rsi, [rip - 0x43]
0x004008bd:	push	r14
0x004008bf:	push	r13
0x004008c1:	push	r12
0x004008c3:	lea	r12, [rip - 0x4e]
0x004008ca:	push	rbp
...
0x00400a68:	call	0x500010
0x00400a6d:	add	rsp, 0x60
0x00400a71:	mov	rdi, rbp
0x00400a74:	call	0x500018
...
0x00400f66:	mov	byte ptr [rip - 0x82c], dl
0x00400f6c:	lea	rdx, [rip - 0x973]
...
0x00401384:	call	0x4002b0
0x00401389:	jmp	0x400ac0
0x00401390:	lea	rdi, [rip - 0xaf5]
0x00401397:	call	0x500020
0x0040139c:	movzx	eax, byte ptr [rsp + 0x1af]
0x004013a4:	movzx	ecx, byte ptr [rsp + 0x1a4]
0x004013ac:	lea	rsi, [rip - 0xb9b]
...
0x00401465:	pop	r15
0x00401467:	ret	
0x00401468:	mov	rdi, qword ptr [rip + 0xfebb9]
0x0040146f:	mov	rcx, r12
0x00401472:	mov	esi, 1
0x00401477:	xor	eax, eax
0x00401479:	lea	rdx, [rip - 0xbf7]
0x00401480:	call	0x500030
0x00401485:	mov	edi, 1
0x0040148a:	call	0x500038
0x0040148f:	call	0x500040
...
0x00500030:	add	byte ptr [rax], al
0x00500032:	add	byte ptr [rax], al
0x00500034:	add	byte ptr [rax], al
0x00500036:	add	byte ptr [rax], al

Function exit @ 0x00500038
0x00500038:	add	byte ptr [rax], al
0x0050003a:	add	byte ptr [rax], al
0x0050003c:	add	byte ptr [rax], al
0x0050003e:	add	byte ptr [rax], al

Function __stack_chk_fail @ 0x00500040
0x00500040:	add	byte ptr [rax], al
0x00500042:	add	byte ptr [rax], al
0x00500044:	add	byte ptr [rax], al
0x00500046:	add	byte ptr [rax], al
0x00500048:	mov	byte ptr [rax], ah
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 00 00 00 04 00 f1 ff 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 00 07 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 07 00 00 00 00 00 09 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 0c 00 00 00 00 00 05 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 11 00 00 00 00 00 06 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 16 00 00 00 00 00 06 00 02 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 1b 00 00 00 00 00 06 00 24 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 20 00 00 00 00 00 05 00 78 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 25 00 00 00 00 00 06 00 28 00 00 00 00 00 00 00

[SECTION] .strtab
  Address: 0x0
  Size   : 230 bytes
  Flags  : 0
  Data (first 256 bytes): 00 41 45 53 2e 63 00 2e 4c 43 30 00 2e 4c 43 31 00 2e 4c 43 32 00 2e 4c 43 33 00 2e 4c 43 35 00 2e 4c 43 36 00 2e 4c 43 37 00 2e 4c 43 38 00 2e 4c 43 34 00 62 79 74 65 53 75 62 00 73 62 6f 78 00 6d 69 78 43 6f 6c 75 6d 6e 00 61 64 64 52 6f 75 6e 64 4b 65 79 00 6e 65 78 74 52 6f 75 6e 64 4b 65 79 00 72 63 6f 6e 5f 69 00 72 63 6f 6e 00 63 6f 70 79 5f 64 61 74 61 00 70 72 69 6e 74 5f 6d 61 74 72 69 78 00 5f 5f 70 72 69 6e 74 66 5f 63 68 6b 00 6d 61 69 6e 00 66 6f 70 65 6e 00 5f 5f 69 73 6f 63 39 39 5f 66 73 63 61 6e 66 00 66 63 6c 6f 73 65 00 70 75 74 73 00 73 74 64 65 72 72 00 5f 5f 66 70 72 69 6e 74 66 5f 63 68 6b 00 65 78 69 74 00 5f 5f 73 74 61 63 6b 5f 63 68 6b 5f 66 61 69 6c 00

[SECTION] .shstrtab
  Address: 0x0
  Size   : 171 bytes
  Flags  : 0
  Data (first 256 bytes): 00 2e 73 79 6d 74 61 62 00 2e 73 74 72 74 61 62 00 2e 73 68 73 74 72 74 61 62 00 2e 72 65 6c 61 2e 74 65 78 74 00 2e 64 61 74 61 00 2e 62 73 73 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 38 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 31 00 2e 72 65 6c 61 2e 74 65 78 74 2e 73 74 61 72 74 75 70 00 2e 72 6f 64 61 74 61 2e 63 73 74 31 36 00 2e 63 6f 6d 6d 65 6e 74 00 2e 6e 6f 74 65 2e 47 4e 55 2d 73 74 61 63 6b 00 2e 6e 6f 74 65 2e 67 6e 75 2e 70 72 6f 70 65 72 74 79 00 2e 72 65 6c 61 2e 65 68 5f 66 72 61 6d 65 00
