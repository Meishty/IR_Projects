...
0x00400000:	endbr64	
0x00400004:	movdqa	xmm0, xmmword ptr [rip]

Function sub_40000c @ 0x0040000c
0x0040000c:	movups	xmmword ptr [rdi], xmm0
0x0040000f:	movdqa	xmm0, xmmword ptr [rip]
...
Function sub_400c00 @ 0x00400c00
0x00400c00:	endbr64	
0x00400c04:	push	r14
0x00400c06:	mov	r8d, edx
0x00400c09:	mov	r14, rdi
...
Function sub_400cfa @ 0x00400cfa
...
Function sub_400e50 @ 0x00400e50
0x00400e50:	endbr64	
0x00400e54:	push	r12
0x00400e56:	lea	r12, [rsi + 0x30]
0x00400e5a:	push	rbp
...
Function sub_400ed6 @ 0x00400ed6
...
[SECTION] .shstrtab
  ...
  Size   : 96 bytes
  Flags  : 0
  Data (first 256 bytes): 00 2e 73 68 73 74 72 74 61 62 00 2e 74 65 78 74 00 2e 64 61 74 61 00 2e 62 73 73 00 2e 72 6f 64 61 74 61 2e 63 73 74 31 36 00 2e 63 6f 6d 6d 65 6e 74 00 2e 6e 6f 74 65 2e 47 4e 55 2d 73 74 61 63 6b 00 2e 6e 6f 74 65 2e 67 6e 75 2e 70 72 6f 70 65 72 74 79 00 2e 65 68 5f 66 72 61 6d 65 00
