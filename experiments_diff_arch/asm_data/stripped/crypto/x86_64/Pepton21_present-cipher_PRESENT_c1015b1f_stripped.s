...
Function sub_400350 @ 0x00400350
0x00400350:	endbr64	
0x00400354:	movsx	ecx, byte ptr [rdi]
0x00400357:	mov	rdx, rdi
0x0040035a:	lea	esi, [rcx - 0x30]
...
0x004005fd:	call	0x400602

Function sub_4005f0 @ 0x004005f0
0x004005f0:	endbr64	
0x004005f4:	push	rbx
0x004005f5:	mov	rbx, rdi
0x004005f8:	mov	edi, 8
...
Function sub_400602 @ 0x00400602
...
0x00400788:	lea	rax, [rip]
0x0040078f:	movzx	eax, byte ptr [rax + rdi]
0x00400793:	ret	

Function sub_400780 @ 0x00400780
0x00400780:	endbr64	
0x00400784:	movzx	edi, dil
0x00400788:	lea	rax, [rip]
0x0040078f:	movzx	eax, byte ptr [rax + rdi]
...
0x00400ca4:	call	0x400ca9

Function sub_400c90 @ 0x00400c90
0x00400c90:	endbr64	
0x00400c94:	push	r13
0x00400c96:	push	r12
0x00400c98:	push	rbp
...
Function sub_401116 @ 0x00401116
...
0x00401515:	call	0x40151a

Function sub_40151a @ 0x0040151a
0x0040151a:	mov	edi, 0x11
0x0040151f:	call	0x401524

Function sub_401524 @ 0x00401524
0x00401524:	mov	r8, rbx
0x00401527:	mov	edx, 0x11
0x0040152c:	lea	rcx, [rip]
0x00401533:	mov	r12, rax
0x00401536:	mov	rdi, rax
0x00401539:	mov	esi, 1
0x0040153e:	xor	eax, eax
0x00401540:	call	0x401545
...
[SECTION] .shstrtab
  ...
  Size   : 126 bytes
  Flags  : 0
  Data (first 256 bytes): 00 2e 73 68 73 74 72 74 61 62 00 2e 74 65 78 74 00 2e 64 61 74 61 00 2e 62 73 73 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 31 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 38 00 2e 74 65 78 74 2e 73 74 61 72 74 75 70 00 2e 63 6f 6d 6d 65 6e 74 00 2e 6e 6f 74 65 2e 47 4e 55 2d 73 74 61 63 6b 00 2e 6e 6f 74 65 2e 67 6e 75 2e 70 72 6f 70 65 72 74 79 00 2e 65 68 5f 66 72 61 6d 65 00
