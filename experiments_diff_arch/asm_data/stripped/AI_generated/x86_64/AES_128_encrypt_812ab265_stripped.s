...
0x00400008:	lea	r11, [rip]
0x0040000f:	lea	r10, [rip]
0x00400016:	push	rbx
...
0x00400ac3:	pop	r15
0x00400ac5:	ret	
0x00400ac6:	call	0x400acb

Function sub_400ae0 @ 0x00400ae0
0x00400ae0:	endbr64	
0x00400ae4:	push	r12
0x00400ae6:	push	rbp
0x00400ae7:	lea	rbp, [rip]
0x00400aee:	push	rbx
0x00400aef:	sub	rsp, 0x40
0x00400af3:	movdqa	xmm0, xmmword ptr [rip]
...
0x00400b1c:	movdqa	xmm0, xmmword ptr [rip]
...
0x00400b31:	call	0x400b36

Function sub_400b36 @ 0x00400b36
0x00400b36:	lea	rsi, [rip]
0x00400b3d:	mov	edi, 1
0x00400b42:	xor	eax, eax
0x00400b44:	call	0x400b49
...
[SECTION] .shstrtab
  ...
  Size   : 133 bytes
  Flags  : 0
  Data (first 256 bytes): 00 2e 73 68 73 74 72 74 61 62 00 2e 74 65 78 74 00 2e 64 61 74 61 00 2e 62 73 73 00 2e 72 6f 64 61 74 61 2e 73 74 72 31 2e 31 00 2e 74 65 78 74 2e 73 74 61 72 74 75 70 00 2e 72 6f 64 61 74 61 00 2e 72 6f 64 61 74 61 2e 63 73 74 31 36 00 2e 63 6f 6d 6d 65 6e 74 00 2e 6e 6f 74 65 2e 47 4e 55 2d 73 74 61 63 6b 00 2e 6e 6f 74 65 2e 67 6e 75 2e 70 72 6f 70 65 72 74 79 00 2e 65 68 5f 66 72 61 6d 65 00
