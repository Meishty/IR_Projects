...
Function fromHexStringToLong @ 0x00400095
...
Function fromLongToBytes @ 0x004000cd
...
Function fromLongToHexString @ 0x00400131
...
Function Sbox @ 0x0040015d
0x0040015d:	ldr	r3, [pc, #4]
0x0040015f:	add	r3, pc
0x00400161:	ldrb	r0, [r3, r0]
0x00400163:	bx	lr

Function inverseSbox @ 0x00400169
...
Function inversepermute @ 0x004001ed
0x004001ed:	push	{r4, r5, r6, lr}
0x004001ef:	mov	r6, r0
0x004001f1:	ldr	r5, [pc, #0x44]
0x004001f3:	movs	r0, #0
...
Function generateSubkeys @ 0x00400275
0x00400275:	subs	r2, r0, #1
0x00400277:	add.w	ip, r0, #0xf
0x0040027b:	push	{r4, r5, r6, lr}
0x0040027d:	ldrb	r3, [r2, #1]!
...
0x0040082f:	bl	#0x4004d5
0x00400833:	bl	#0x500025
0x00400837:	mov	r0, r4
0x00400839:	bl	#0x500019
0x0040083d:	mov	r0, r6
0x0040083f:	bl	#0x500019
0x00400843:	mov	r0, r5
0x00400845:	bl	#0x500019
