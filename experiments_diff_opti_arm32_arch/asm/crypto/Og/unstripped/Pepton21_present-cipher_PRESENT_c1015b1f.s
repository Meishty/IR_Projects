...
Function fromBytesToLong @ 0x00400069
0x00400069:	push	{lr}
...
Function fromHexStringToLong @ 0x004000a3
...
Function fromLongToBytes @ 0x004000eb
...
Function fromLongToHexString @ 0x00400159
...
Function Sbox @ 0x00400185
0x00400185:	ldr	r3, [pc, #4]
0x00400187:	add	r3, pc
0x00400189:	ldrb	r0, [r3, r0]
0x0040018b:	bx	lr

Function inverseSbox @ 0x00400191
...
Function inversepermute @ 0x0040020d
0x0040020d:	push	{r4, r5, lr}
0x0040020f:	mov	r4, r0
0x00400211:	mov	r5, r1
0x00400213:	mov.w	ip, #0
...
0x00400351:	bl	#0x400069
0x00400355:	bl	#0x4001a1
0x00400359:	mov	r5, r0
0x0040035b:	mov	r4, r1
0x0040035d:	mov	r0, r6
0x0040035f:	bl	#0x500019
...
0x00400407:	bl	#0x40020d
0x0040040b:	bl	#0x4000eb
...
0x0040042b:	bl	#0x400159
0x0040042f:	pop.w	{r4, r5, r6, r7, r8, pc}

Function main @ 0x00400433
