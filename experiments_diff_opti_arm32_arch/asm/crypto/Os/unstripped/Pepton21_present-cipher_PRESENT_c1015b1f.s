...
Function fromBytesToLong @ 0x0040005d
...
Function fromHexStringToLong @ 0x0040008f
...
Function fromLongToBytes @ 0x004000c3
...
Function fromLongToHexString @ 0x0040011b
...
Function Sbox @ 0x00400145
0x00400145:	ldr	r3, [pc, #4]
0x00400147:	add	r3, pc
0x00400149:	ldrb	r0, [r3, r0]
0x0040014b:	bx	lr

Function inverseSbox @ 0x00400151
...
Function inversepermute @ 0x004001c5
...
0x00400315:	bl	#0x40005d
0x00400319:	bl	#0x400161
0x0040031d:	mov	r5, r0
0x0040031f:	mov	r0, sb
0x00400321:	mov	r4, r1
0x00400323:	bl	#0x500019
...
0x00400347:	b.w	#0x40011b

Function sub_40034b @ 0x0040034b
0x0040034b:	nop	
0x0040034d:	lsls	r2, r2, #4
...
0x0040035b:	bl	#0x40024b

Function decrypt @ 0x00400351
0x00400351:	push.w	{r0, r1, r2, r4, r5, r6, r7, r8, sb, lr}
0x00400355:	mov	r4, r0
0x00400357:	ldr	r7, [pc, #0x90]
0x00400359:	mov	r0, r1
...
0x0040037d:	bl	#0x4001c5
0x00400371:	ldrd	r0, r1, [sb]
0x00400375:	sub.w	sb, sb, #8
0x00400379:	eors	r0, r5
0x0040037b:	eors	r1, r4
0x0040037d:	bl	#0x4001c5
0x00400381:	bl	#0x4000c3
...
0x004003e3:	b.w	#0x40011b

Function sub_4003e7 @ 0x004003e7
0x004003e7:	nop	
0x004003e9:	lsls	r6, r7, #1
0x004003eb:	movs	r0, r0

Function main @ 0x00400559
