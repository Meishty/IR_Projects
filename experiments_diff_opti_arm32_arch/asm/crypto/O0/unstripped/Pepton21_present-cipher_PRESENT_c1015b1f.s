...
Function fromBytesToLong @ 0x004000e7
...
Function fromHexStringToLong @ 0x00400195
...
Function fromLongToBytes @ 0x00400217
...
Function fromLongToHexString @ 0x004002cf
...
Function inverseSbox @ 0x00400325
0x00400325:	push	{r7}
0x00400327:	sub	sp, #0xc
0x00400329:	add	r7, sp, #0
0x0040032b:	mov	r3, r0
...
Function inversepermute @ 0x004003f9
0x004003f9:	push.w	{r4, r5, r6, r7, r8, sb, sl, fp}
0x004003fd:	sub	sp, #0x28
0x004003ff:	add	r7, sp, #0
0x00400401:	strd	r0, r1, [r7, #0x10]
...
Function generateSubkeys @ 0x00400515
...
0x00400785:	bl	#0x500019
0x00400789:	ldrd	r0, r1, [r7, #0x18]
0x0040078d:	bl	#0x4002cf
...
0x00400899:	bl	#0x500019
0x0040089d:	ldrd	r0, r1, [r7, #0x18]
0x004008a1:	bl	#0x4002cf
...
0x0040093b:	nop	
0x0040093d:	lsls	r4, r4, #3
0x0040093f:	movs	r0, r0
0x00400941:	lsls	r0, r0, #5
0x00400943:	movs	r0, r0
0x00400945:	lsls	r6, r1, #6
0x00400947:	movs	r0, r0
0x00400949:	lsls	r2, r2, #6
